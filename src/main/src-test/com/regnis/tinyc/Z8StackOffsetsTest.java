...
public class Z8StackOffsetsTest {
	...
	public void testNoVars() {
		...
		Assert.assertEquals(0, offsets.localVarSpace());
	...
	public void testLocalVars() {
		...
		Assert.assertEquals(2, offsets.localVarSpace());
		Assert.assertEquals(0, offsets.getCallArgSpace());
		...
		Assert.assertEquals(3, offsets.localVarSpace());
		Assert.assertEquals(0, offsets.getCallArgSpace());
		Assert.assertEquals(0, offsets.getOffset(a));
	...
	public void testArgs() {
		...
		assertEquals(4, offsets.localVarSpace());
