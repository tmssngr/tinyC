...
public class ParserTest {
	...
	public void testDeclaration() {
		...
		assertEquals(new StmtVarDeclaration("i16*", "foo", new ExprVarRead("bar", loc(0, 11)),
		                                    loc(0, 0)),
	...
	public void testAssignment() {
		...
		assertEquals(assignStmt(new ExprDeref(new ExprVarRead("foo", loc(0, 1)),
		                                      loc(0, 0)),
		...
		assertEquals(assignStmt(new ExprDeref(new ExprBinary(ExprBinary.Op.Add,
		                                                     new ExprVarRead("foo", loc(0, 2)),
		                                                     new ExprIntLiteral(2, loc(0, 8)),
		                                                     loc(0, 6)),
		                                      loc(0, 0)),
		                        new ExprVarRead("bar", loc(0, 13)),
		                        loc(0, 11)),
	...
	public void testFor() {
		assertEquals(new StmtFor(List.of(
				             new StmtVarDeclaration("i16", "i", intLit(0, loc(0, 13)),
		                         ...
		                         new ExprBinary(ExprBinary.Op.Lt,
		                                        ...
		                                        loc(0, 18)),
		                         new StmtCompound(List.of(
				                         printStmt(new ExprVarRead("i", loc(1, 8)),
				                                   loc(1, 2))
		                         )),
		                         List.of(
				                         assignStmt(new ExprVarRead("i", loc(0, 24)),
				                                    new ExprBinary(ExprBinary.Op.Add,
				                                                   new ExprVarRead("i", loc(0, 28)),
				                                                   intLit(1, loc(0, 32)),
				                                                   loc(0, 30)),
				                                    loc(0, 26))
		                         ),
		...
		assertEquals(new StmtCompound(List.of(
				             ...
				             new StmtFor(List.of(),
				                         ...
				                         List.of(
						                         assignStmt(new ExprVarRead("i", loc(2, 15)),
						                                    new ExprBinary(ExprBinary.Op.Add,
						                                                   new ExprVarRead("i", loc(2, 19)),
						                                                   intLit(1, loc(2, 23)),
						                                                   loc(2, 21)),
						                                    loc(2, 17))
				                         ),
				...
				new Function("void", "main", List.of(),
				             new StmtCompound(List.of(
						             new StmtVarDeclaration("u8", "i", intLit(10, loc(1, 11)),
						                                    loc(1, 4)),
						             printStmt(new ExprVarRead("i", loc(2, 10)),
						                       loc(2, 4))
				             )),
				             loc(0, 0)),
				...
				new Function("void", "main", List.of(),
				             new StmtCompound(List.of(
						             ...
						             new StmtIf(new ExprBinary(ExprBinary.Op.Equals,
						                        ...
						                        null,
						                        loc(2, 4)),
						             printStmt(new ExprVarRead("i", loc(4, 10)),
						                       loc(4, 4))
				             )),
				             loc(0, 0)),
