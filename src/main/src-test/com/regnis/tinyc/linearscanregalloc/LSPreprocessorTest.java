...
public class LSPreprocessorTest {
	...
	public void testArgs() {
		...
		final var result = LSPreprocessor.process(new IRFunction("name", Type.BOOL,
	...
	public void testAddressedGlobal() {
		...
		final IRVar varTempA = new IRVar(IRCachedVarConverterLayer.TMP_PREFIX + "a", 2, VariableScope.function, Type.I16);
		...
		final LSCallingConventionProvider callingConventionProvider = (targetType, argTypes) -> LSCallingConvention.createX86CallingConvention(2, 0);
		final var result = LSPreprocessor.process(new IRFunction("name", Type.VOID, localVarInfos,
		                                                         List.of(
				                                                         new IRMove(varA, 1),
	...
	public void testPrintChar() {
		...
		final LSCallingConventionProvider callingConventionProvider = (targetType, argTypes) -> LSCallingConvention.createX86CallingConvention(2, 0);
		final var result = LSPreprocessor.process(new IRFunction("printChar", Type.VOID, localVarInfos,
		                                                         List.of(
		...
		assertEquals(new IRCall(null, Type.VOID, "printStringLength", IRValue.toValues(varT1.asRegister(1), varT2.asRegister(2))), it.next());
