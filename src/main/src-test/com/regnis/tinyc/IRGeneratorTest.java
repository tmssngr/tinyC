...
public class IRGeneratorTest {
	...
	public void testBreakContinue() {
		...
		assertEquals(new IRProgram(List.of(
				             ...
				             new IRFunction("foo", "@foo", Type.VOID, List.of(
									 ...
									 new IRComment("7:13 >"),
									 new IRCompare(ExprBinary.Op.Gt, 2, 1, 0, Type.U8),
									 new IRBranch(2, false, "@else_2"),
									 new IRComment("then"),
									 new IRJump("@while_1"),
									 new IRJump("@endif_2"),
									 new IRComment("else"),
									 ...
									 new IRComment("10:13 =="),
									 new IRCompare(ExprBinary.Op.Equals, 2, 1, 0, Type.U8),
									 new IRBranch(2, false, "@else_3"),
									 new IRComment("then"),
	...
	private IRProgram convert(String input) {
		final Program rawProgram = new Parser(new Lexer(input)).parse();
