...
public class LinearScanRegisterAllocationTest {
	...
	public void testPrintChar() {
		final IRVar chr = new IRVar("chr", 0, VariableScope.argument, Type.U8, true);
	...
	public void testPrintUint_while_1_break() {
		final IRVar pos = new IRVar("pos", 2, VariableScope.function, Type.U8, true);
		final IRVar buffer = new IRVar("buffer", 1, VariableScope.function, Type.POINTER_U8, false);
		...
		assertEquals(List.of(
				copy(reg(0, pos), pos),
				cast(reg(1, t15), reg(0, pos)),
				new IRAddrOfArray(reg(1, t14),
				                  buffer,
				                  reg(1, t15),
				                  true, LOCATION),
				literal(reg(2, t18), 0x20),
				sub(reg(0, t17), reg(2, t18), reg(0, pos)),
				cast(reg(0, t16), reg(0, t17)),
				new IRCall(null, "printStringLength",
				           List.of(reg(1, t14), reg(0, t16)),
				           LOCATION)
		), allocate(List.of(
				cast(t15, pos),
