...
_main:
        ...
        ; const t.zero{r6}, 48
        mov bl, 48
        ; addrof a.zero{r7}, zero
        lea r12, [var_0]
        ; store [a.zero{r7}], t.zero{r6}
        mov [r12], bl
        ; const t.one{r6}, 49
        mov bl, 49
        ; addrof a.one{r7}, one
        lea r12, [var_1]
        ; store [a.one{r7}], t.one{r6}
        mov [r12], bl
        ; const t.two{r6}, 50
        mov bl, 50
        ; addrof a.two{r7}, two
        lea r12, [var_2]
        ; store [a.two{r7}], t.two{r6}
        mov [r12], bl
        ; const t.threeFour{r6}, 34
        mov bl, 34
        ; addrof a.threeFour{r7}, threeFour
        lea r12, [var_3]
        ; store [a.threeFour{r7}], t.threeFour{r6}
        mov [r12], bl
        ...
        ; addrof a.zero1{r6}, zero
        lea rbx, [var_0]
        ; load t.zero1{r1}, [a.zero1{r6}]
        mov cl, [rbx]
        ; call printChar@u8[t.zero1{r1}]
        call _printChar@u8
        ...
        ; const t.7{r7}, 0
        mov r12, 0
        ; add t.6{r6}, t.6{r6}, t.7{r7}
        add rbx, r12
        ; load t.5{r1}, [t.6{r6}]
        mov cl, [rbx]
        ; call printChar@u8[t.5{r1}]
        call _printChar@u8
        ; addrof a.threeFour1{r6}, threeFour
        lea rbx, [var_3]
        ; load t.threeFour1{r1}, [a.threeFour1{r6}]
        mov cl, [rbx]
        ; call printUint@u8[t.threeFour1{r1}]
        call _printUint@u8
        ; const arg.5.0{r1}, 10
        mov cl, 10
