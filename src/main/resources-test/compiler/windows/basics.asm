...
_main:
        ...
        ; const t.zero{r6}, 48
        mov bl, 48
        ; addrof a.zero{r0}, zero
        lea rax, [var_0]
        ; store [a.zero{r0}], t.zero{r6}
        mov [rax], bl
        ; const t.one{r6}, 49
        mov bl, 49
        ; addrof a.one{r0}, one
        lea rax, [var_1]
        ; store [a.one{r0}], t.one{r6}
        mov [rax], bl
        ; const t.two{r6}, 50
        mov bl, 50
        ; addrof a.two{r0}, two
        lea rax, [var_2]
        ; store [a.two{r0}], t.two{r6}
        mov [rax], bl
        ; const t.threeFour{r6}, 34
        mov bl, 34
        ; addrof a.threeFour{r0}, threeFour
        lea rax, [var_3]
        ; store [a.threeFour{r0}], t.threeFour{r6}
        mov [rax], bl
