...
_main:
        ...
        lea rbx, [rsp+40]
        mov [rbx], rax
        ; load t.text1, [a.text1]
        lea rax, [rsp+40]
        mov rbx, [rax]
        mov rax, [rbx]
        lea rbx, [rsp+48]
        mov [rbx], rax
        ; call printString@@u8[t.text1]
        lea rax, [rsp+48]
        mov rbx, [rax]
        push rbx
