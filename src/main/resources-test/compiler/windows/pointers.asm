...
@main:
        ...
        ; const tmp.a{r1}, 10
        mov cx, 10
        ; addrof spillHelper{r7}, a
        lea r12, [rsp+48]
        ; store [spillHelper{r7}], tmp.a{r1}
        mov [r12], cx
        ...
        ; const t.5{r0}, 1
        mov ax, 1
        ; sub tmp.c{r6}, tmp.c{r6}, t.5{r0}
        sub bx, ax
        ; addrof spillHelper{r7}, c
        lea r12, [rsp+50]
        ; store [spillHelper{r7}], tmp.c{r6}
        mov [r12], bx
        ; move tmp.c{r1}, tmp.c{r6}
        mov cx, bx
