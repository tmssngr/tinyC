...
@while_4_body:
        ...
        ; const t.3{r7}, 1
        mov r12b, 1
        ; sub i{r6}, i{r6}, t.3{r7}
        sub bl, r12b
@while_4:
        ; const t.2{r7}, 0
        mov r12b, 0
        ; gt t.1{r7}, i{r6}, t.2{r7}
        cmp bl, r12b
        seta r12b
        ; branch t.1{r7}, true, @while_4_body, @while_5
        or r12b, r12b
        jnz @while_4_body
@while_5:
        ; move i{r1}, i{r6}
        ...
        ; const t.4{r0}, 1
        mov al, 1
        ; add i{r6}, i{r6}, t.4{r0}
        add bl, al
        ; 13:3 if i < 5
        ; const t.6{r0}, 5
        mov al, 5
        ; lt t.5{r0}, i{r6}, t.6{r0}
        cmp bl, al
        setb al
        ; branch t.5{r0}, true, @while_5, @main_ret
        or al, al
        jnz @while_5
        add rsp, 32
        ; restore clobbered non-volatile registers
