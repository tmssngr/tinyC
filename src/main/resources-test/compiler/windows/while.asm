...
_while_4_body:
        ...
        mov [rax], bl
_while_4:
        ; branch i.2 gt 0: while_4_body, while_4_break
        lea rax, [rsp+1]
        mov bl, [rax]
        cmp bl, 0
        ja _while_4_body
...
_while_5:
        ...
        mov [rax], bl
        ; 13:3 if i < 5
        ; branch i.5 lt 5: main.no_critical_edge_8, main_ret
        lea rax, [rsp+4]
        mov bl, [rax]
        cmp bl, 5
        jb _main.no_critical_edge_8
        ; release space for local variables
        add rsp, 16
        ret
