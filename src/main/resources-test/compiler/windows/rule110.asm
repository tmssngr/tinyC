...
@for_6:
        ...
        lea rax, [rsp+96]
        mov [rax], bl
        ; branch t.21, true, @for_6_body, @for_6_break
        lea rax, [rsp+96]
        mov bl, [rax]
        or bl, bl
        jnz @for_6_body
...
@for_5:
        ...
        lea rax, [rsp+48]
        mov [rax], bl
        ; branch t.12, true, @for_5_body, @main_ret
        lea rax, [rsp+48]
        mov bl, [rax]
        or bl, bl
        jnz @for_5_body
