...
_main:
        ...
        ; const t.3.1{r7}, 0
        mov r12, 0
        ; addrof t.2.1{r0}, [chars]
        lea rax, [var_0]
        ; add t.2.2{r0}, t.2.2{r0}, t.3.1{r7}
        add rax, r12
        ; store [t.2.2{r0}], chr.1{r6}
        mov [rax], bl
        ; const t.7.1{r6}, 0
        mov rbx, 0
        ; addrof t.6.1{r7}, [chars]
        lea r12, [var_0]
        ; add t.6.2{r7}, t.6.2{r7}, t.7.1{r6}
        add r12, rbx
        ; load t.5.1{r6}, [t.6.2{r7}]
        mov bl, [r12]
        ; add t.4.1{r6}, t.4.1{r6}, 1
        add bl, 1
        ; const t.9.1{r7}, 1
        mov r12, 1
        ; addrof t.8.1{r0}, [chars]
        lea rax, [var_0]
        ; add t.8.2{r0}, t.8.2{r0}, t.9.1{r7}
        add rax, r12
        ; store [t.8.2{r0}], t.4.1{r6}
        mov [rax], bl
        ; const t.13.1{r6}, 1
        mov rbx, 1
        ; addrof t.12.1{r7}, [chars]
        lea r12, [var_0]
        ; add t.12.2{r7}, t.12.2{r7}, t.13.1{r6}
        add r12, rbx
        ; load t.11.1{r6}, [t.12.2{r7}]
        mov bl, [r12]
        ; add t.10.1{r6}, t.10.1{r6}, 2
        add bl, 2
        ; const t.15.1{r7}, 2
        mov r12, 2
        ; addrof t.14.1{r0}, [chars]
        lea rax, [var_0]
        ; add t.14.2{r0}, t.14.2{r0}, t.15.1{r7}
        add rax, r12
        ; store [t.14.2{r0}], t.10.1{r6}
        mov [rax], bl
        ; const t.17.1{r6}, 2
        mov rbx, 2
        ; addrof t.16.1{r7}, [chars]
        lea r12, [var_0]
        ; add t.16.2{r7}, t.16.2{r7}, t.17.1{r6}
        add r12, rbx
        ; load result.1{r1}, [t.16.2{r7}]
        mov cl, [r12]
