...
_main:
        ...
        lea rax, [var_0]
        ; store [a.space{r0}], t.space{r6}
        mov [rax], bx
        ; const t.next{r6}, 63
        mov bx, 63
        ; addrof a.next{r0}, next
        lea rax, [var_1]
        ; store [a.next{r0}], t.next{r6}
        mov [rax], bx
        ; addrof t.ptrToSpace{r6}, space
        lea rbx, [var_0]
        ; addrof a.ptrToSpace{r0}, ptrToSpace
        lea rax, [var_2]
        ; store [a.ptrToSpace{r0}], t.ptrToSpace{r6}
        mov [rax], rbx
