...
@and_next_5:
        ...
        lea r11, [rsp+53]
        mov [r11], al
        ; branch t.26{r1}, false, @and_next_6
        or cl, cl
        jz @and_next_6
        ; move t{r1}, t
        lea r11, [rsp+52]
...
@and_next_6:
        ...
        lea r11, [rsp+52]
        mov [r11], al
        ; branch t.27{r1}, false, @and_next_7
        or cl, cl
        jz @and_next_7
        ; move f{r1}, f
        lea r11, [rsp+53]
...
@or_next_9:
        ...
        lea r11, [rsp+53]
        mov [r11], al
        ; branch t.31{r1}, true, @or_next_10
        or cl, cl
        jnz @or_next_10
        ; move t{r1}, t
        lea r11, [rsp+52]
...
@or_next_10:
        ...
        lea r11, [rsp+52]
        mov [r11], al
        ; branch t.32{r1}, true, @or_next_11
        or cl, cl
        jnz @or_next_11
        ; move f{r1}, f
        lea r11, [rsp+53]
...
@or_next_11:
        ...
        ; move t.33{r1}, t{r0}
        mov cl, al
        ; branch t.33{r1}, false, @or_2nd_12
        or cl, cl
        jz @or_2nd_12
        ; move t, t{r0}
        lea r11, [rsp+52]
...
@or_next_12:
        ...
        cmp r12w, bx
        sete cl
        ; branch t.40{r1}, true, @or_next_13
        or cl, cl
        jnz @or_next_13
        ; move d{r1}, d
        lea r11, [rsp+50]
...
@or_next_13:
        ...
        cmp r12w, bx
        sete cl
        ; branch t.41{r1}, false, @and_next_14
        or cl, cl
        jz @and_next_14
        ; move d{r1}, d
        lea r11, [rsp+50]
