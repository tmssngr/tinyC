...
@for_5_body:
        ...
        cmp al, 0
        sete r12b
        ; branch t.10{r7}, false, @if_6_end, @if_6_then
        or r12b, r12b
        jz @if_6_end
        ; move i{r1}, i{r6}
        mov cl, bl
...
@if_6_end:
        ...
        cmp al, 0
        sete r12b
        ; branch t.13{r7}, false, @if_7_end, @if_7_then
        or r12b, r12b
        jz @if_7_end
        ; const t.16{r1}, 32
        mov cl, 32
...
@if_7_end:
        ...
        cmp al, 15
        sete r12b
        ; branch t.17{r7}, false, @for_5_continue, @if_8_then
        or r12b, r12b
        jz @for_5_continue
        ; const t.20{r1}, 10
        mov cl, 10
...
@for_5:
        ...
        cmp bl, 128
        setb al
        ; branch t.9{r0}, true, @for_5_body, @main_ret
        or al, al
        jnz @for_5_body
        add rsp, 32
        ; restore clobbered non-volatile registers
