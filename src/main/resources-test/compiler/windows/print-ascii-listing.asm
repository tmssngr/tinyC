...
@for_5_body:
        ...
        ; move t.13{r7}, i{r6}
        mov r12b, bl
        ; and t.13{r7}, t.13{r7}, 15
        and r12b, 15
        ; const t.14{r0}, 0
        mov al, 0
        ; equals t.12{r7}, t.13{r7}, t.14{r0}
        cmp r12b, al
        sete r12b
        ; branch t.12{r7}, false, @if_6_end, @if_6_then
        or r12b, r12b
        jz @if_6_end
        ; move i{r1}, i{r6}
        mov cl, bl
...
@if_6_end:
        ...
        ; move t.16{r7}, i{r6}
        mov r12b, bl
        ; and t.16{r7}, t.16{r7}, 7
        and r12b, 7
        ; const t.17{r0}, 0
        mov al, 0
        ; equals t.15{r7}, t.16{r7}, t.17{r0}
        cmp r12b, al
        sete r12b
        ; branch t.15{r7}, false, @if_7_end, @if_7_then
        or r12b, r12b
        jz @if_7_end
        ; const t.18{r1}, 32
        mov cl, 32
        ; call printChar@u8[t.18{r1}]
        call @printChar@u8
@if_7_end:
        ; move i{r1}, i{r6}
        mov cl, bl
        ...
        ; move t.20{r7}, i{r6}
        mov r12b, bl
        ; and t.20{r7}, t.20{r7}, 15
        and r12b, 15
        ; const t.21{r0}, 15
        mov al, 15
        ; equals t.19{r7}, t.20{r7}, t.21{r0}
        cmp r12b, al
        sete r12b
        ; branch t.19{r7}, false, @for_5_continue, @if_8_then
        or r12b, r12b
        jz @for_5_continue
        ; const t.22{r1}, 10
        mov cl, 10
...
@for_5:
        ; const t.11{r0}, 128
        mov al, 128
        ; lt t.10{r0}, i{r6}, t.11{r0}
        cmp bl, al
        setb al
        ; branch t.10{r0}, true, @for_5_body, @main_ret
        or al, al
        jnz @for_5_body
        add rsp, 32
        ; restore clobbered non-volatile registers
