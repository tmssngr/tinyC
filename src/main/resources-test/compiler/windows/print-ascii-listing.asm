...
@for_5_body:
        ...
        lea rax, [rsp+26]
        mov [rax], bl
        ; branch t.13, false, @if_6_end, @if_6_then
        lea rax, [rsp+26]
        mov bl, [rax]
        or bl, bl
        jz @if_6_end
...
@if_6_end:
        ...
        lea rax, [rsp+30]
        mov [rax], bl
        ; branch t.17, false, @if_7_end, @if_7_then
        lea rax, [rsp+30]
        mov bl, [rax]
        or bl, bl
        jz @if_7_end
...
@if_7_end:
        ...
        lea rax, [rsp+35]
        mov [rax], bl
        ; branch t.22, false, @for_5_continue, @if_8_then
        lea rax, [rsp+35]
        mov bl, [rax]
        or bl, bl
        jz @for_5_continue
