...
_main:
        ...
        ; move b{r1}, b{r7}
        mov cx, r12w
        ; shiftright t.8{r6}, t.8{r6}, b{r1}
        sar bx, cl
        ; move t.8{r1}, t.8{r6}
        mov cx, bx
        ; call printIntLf@i16[t.8{r1}]
        call _printIntLf@i16
        ; const a{r6}, 9
        mov bx, 9
        ; const b{r7}, 2
        ...
        ; move b{r1}, b{r7}
        mov cx, r12w
        ; shiftleft t.10{r6}, t.10{r6}, b{r1}
        sal bx, cl
