...
_main:
        ...
        ; const foo.1{r6}, 22
        mov bx, 22
        ; move bar.1{r7}, foo.1{r6}
        mov r12w, bx
        ; mul bar.1{r7}, bar.1{r7}, foo.1{r6}
        movsx r12, r12w
        movsx rbx, bx
        imul  r12, rbx
        ; const foo.2{r6}, 1
        mov bx, 1
        ; move t.5.1{r1}, bar.1{r7}
        mov cx, r12w
        ; add t.5.1{r1}, t.5.1{r1}, foo.2{r6}
        add cx, bx
        ; call printIntLf@i16[t.5.1{r1}]
        call _printIntLf@i16
        ; const foo.3{r1}, 21
        mov cx, 21
        ; call printIntLf@i16[foo.3{r1}]
        call _printIntLf@i16
        ; const bazz.1{r1}, 0
        mov cx, 0
        ; call printIntLf@i16[bazz.1{r1}]
        call _printIntLf@i16
        ; const a.1{r6}, 1000
        mov bx, 1000
        ; const b.1{r7}, 10
        mov r12w, 10
        ; move t.6.1{r1}, a.1{r6}
        mov cx, bx
        ; move t.6.1{r0}, t.6.1{r1}
        mov ax, cx
        ; div t.6.1{r0}, t.6.1{r0}, b.1{r7}
        movsx rax, ax
        movsx r12, r12w
        cqo
        idiv r12
        ; move t.6.1{r1}, t.6.1{r0}
        mov cx, ax
        ; call printIntLf@i16[t.6.1{r1}]
        call _printIntLf@i16
        ; move t.7.1{r1}, a.1{r6}
        mov cx, bx
        ; and t.7.1{r1}, t.7.1{r1}, 255
        and cx, 255
        ...
        ; const b.2{r1}, 1
        mov cx, 1
        ; shiftright t.8.1{r6}, t.8.1{r6}, b.2{r1}
        sar bx, cl
        ; move t.8.1{r1}, t.8.1{r6}
        mov cx, bx
        ; call printIntLf@i16[t.8.1{r1}]
        call _printIntLf@i16
        ; const a.3{r6}, 9
        mov bx, 9
        ; const b.3{r7}, 2
        ...
        ; move b.3{r1}, b.3{r7}
        mov cx, r12w
        ; shiftright t.9.1{r6}, t.9.1{r6}, b.3{r1}
        sar bx, cl
        ; move t.9.1{r1}, t.9.1{r6}
        mov cx, bx
        ; call printIntLf@i16[t.9.1{r1}]
        call _printIntLf@i16
        ; const a.4{r6}, 1
        mov bx, 1
        ; move b.3{r1}, b.3{r7}
        mov cx, r12w
        ; shiftleft t.10.1{r6}, t.10.1{r6}, b.3{r1}
        sal bx, cl
        ; move t.10.1{r1}, t.10.1{r6}
        mov cx, bx
