...
_printLeft:
        ...
        lea rbx, [rsp+12]
        mov [rbx], ax
        ; call setCursor@i16@i16[t.6, t.7]
        lea rax, [rsp+10]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+20]
...
_if_41_then:
        ; 224:4 if printLeft([])
        ; call t.11 = printLeft[] -> bool
        sub rsp, 8
          call _printLeft
        add rsp, 8
        lea rbx, [rsp+33]
        mov [rbx], al
        ; branch t.11, true, if_42_then, if_41_end
        lea rax, [rsp+33]
        mov bl, [rax]
        or bl, bl
        jnz _if_42_then
_if_41_end:
        ...
        lea rax, [rsp+48]
        mov [rax], bl
        ; branch t.13, true, main_ret, if_43_end
        lea rax, [rsp+48]
        mov bl, [rax]
        or bl, bl
        jnz _main_ret
        ...
        lea rax, [rsp+52]
        mov [rax], bl
        ; branch t.15, true, if_44_then, if_44_else
        lea rax, [rsp+52]
        mov bl, [rax]
        or bl, bl
        jnz _if_44_then
        ...
        lea rax, [rsp+66]
        mov [rax], bl
        ; branch t.22, false, if_45_else, if_45_then
        lea rax, [rsp+66]
        mov bl, [rax]
        or bl, bl
        jz _if_45_else
...
_if_45_else:
        ...
        lea rax, [rsp+76]
        mov [rax], bl
        ; branch t.27, false, if_46_else, if_46_then
        lea rax, [rsp+76]
        mov bl, [rax]
        or bl, bl
        jz _if_46_else
...
_if_46_else:
        ...
        lea rax, [rsp+90]
        mov [rax], bl
        ; branch t.34, false, if_47_else, if_47_then
        lea rax, [rsp+90]
        mov bl, [rax]
        or bl, bl
        jz _if_47_else
...
_if_47_else:
        ...
        lea rax, [rsp+100]
        mov [rax], bl
        ; branch t.39, false, if_48_else, if_48_then
        lea rax, [rsp+100]
        mov bl, [rax]
        or bl, bl
        jz _if_48_else
...
_if_48_else:
        ...
        lea rax, [rsp+108]
        mov [rax], bl
        ; branch t.45, false, while_40, if_51_then
        lea rax, [rsp+108]
        mov bl, [rax]
        or bl, bl
        jz _while_40
        jmp _if_51_then
_if_48_then:
        ; 253:4 if !needsInitialize
        ; notlog t.41, needsInitialize
        lea rax, [rsp+0]
        mov bl, [rax]
        or bl, bl
        sete bl
        lea rax, [rsp+104]
        mov [rax], bl
        ; branch t.41, false, while_40, if_49_then
        lea rax, [rsp+104]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_49_then:
        ...
        lea rax, [rsp+105]
        mov [rax], bl
        ; branch t.42, false, while_40, if_50_then
        lea rax, [rsp+105]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_52_end:
        ...
        lea rax, [rsp+112]
        mov [rax], bl
        ; branch t.47, false, if_53_end, if_53_then
        lea rax, [rsp+112]
        mov bl, [rax]
        or bl, bl
        jz _if_53_end
        ...
        lea rax, [rsp+114]
        mov [rax], bl
        ; call setCell@i16@i16@u8[curr_r, curr_c, t.49]
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+10]
...
_if_53_end:
        ...
        lea rbx, [rsp+116]
        mov [rbx], al
        ; branch t.51, true, if_54_then, if_54_end
        lea rax, [rsp+116]
        mov bl, [rax]
        or bl, bl
        jnz _if_54_then
...
_while_40:
        ...
        lea rax, [rsp+32]
        mov [rax], bl
        ; branch t.10, false, if_41_end, if_41_then
        lea rax, [rsp+32]
        mov bl, [rax]
        or bl, bl
        jz _if_41_end
