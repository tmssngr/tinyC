...
_if_45_else:
        ...
        lea rax, [rsp+66]
        mov [rax], bl
        ; branch t.22, false, if_46_else, if_46_then
        lea rax, [rsp+66]
        mov bl, [rax]
        or bl, bl
        jz _if_46_else
...
_if_46_else:
        ...
        lea rax, [rsp+74]
        mov [rax], bl
        ; branch t.26, false, if_47_else, if_47_then
        lea rax, [rsp+74]
        mov bl, [rax]
        or bl, bl
        jz _if_47_else
...
_if_47_else:
        ...
        lea rax, [rsp+80]
        mov [rax], bl
        ; branch t.29, false, if_48_else, if_48_then
        lea rax, [rsp+80]
        mov bl, [rax]
        or bl, bl
        jz _if_48_else
...
_if_48_else:
        ...
        lea rax, [rsp+87]
        mov [rax], bl
        ; branch t.34, false, while_40, if_51_then
        lea rax, [rsp+87]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_48_then:
        ...
        lea rax, [rsp+84]
        mov [rax], bl
        ; branch t.31, false, while_40, if_49_then
        lea rax, [rsp+84]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_52_end:
        ...
        lea rax, [rsp+90]
        mov [rax], bl
        ; branch t.36, false, if_53_end, if_53_then
        lea rax, [rsp+90]
        mov bl, [rax]
        or bl, bl
        jz _if_53_end
        ...
        lea rax, [rsp+92]
        mov [rax], bl
        ; call setCell@i16@i16@u8[curr_r, curr_c, t.38]
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+10]
...
_if_53_end:
        ...
        lea rbx, [rsp+93]
        mov [rbx], al
        ; branch t.39, true, if_54_then, if_54_end
        lea rax, [rsp+93]
        mov bl, [rax]
        or bl, bl
        jnz _if_54_then
