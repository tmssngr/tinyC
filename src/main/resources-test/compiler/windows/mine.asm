...
_if_47_else:
        ...
        lea rax, [rsp+44]
        mov [rax], bl
        ; branch t.20, false, if_48_else, if_48_then
        lea rax, [rsp+44]
        mov bl, [rax]
        or bl, bl
        jz _if_48_else
...
_if_48_else:
        ...
        lea rax, [rsp+48]
        mov [rax], bl
        ; branch t.24, false, while_40, if_51_then
        lea rax, [rsp+48]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_48_then:
        ...
        lea rax, [rsp+45]
        mov [rax], bl
        ; branch t.21, false, while_40, if_49_then
        lea rax, [rsp+45]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_49_then:
        ...
        lea rax, [rsp+46]
        mov [rax], bl
        ; branch t.22, false, while_40, if_50_then
        lea rax, [rsp+46]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_52_end:
        ...
        lea rax, [rsp+49]
        mov [rax], bl
        ; branch t.25, false, if_53_end, if_53_then
        lea rax, [rsp+49]
        mov bl, [rax]
        or bl, bl
        jz _if_53_end
        ...
        lea rax, [rsp+51]
        mov [rax], bl
        ; call setCell@i16@i16@u8[curr_r, curr_c, t.27]
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+10]
...
_if_53_end:
        ...
        lea rbx, [rsp+52]
        mov [rbx], al
        ; branch t.28, true, if_54_then, if_54_end
        lea rax, [rsp+52]
        mov bl, [rax]
        or bl, bl
        jnz _if_54_then
