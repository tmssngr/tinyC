...
_if_47_else:
        ...
        lea rax, [rsp+64]
        mov [rax], bl
        ; branch t.26, false, if_48_else, if_48_then
        lea rax, [rsp+64]
        mov bl, [rax]
        or bl, bl
        jz _if_48_else
...
_if_48_else:
        ...
        lea rax, [rsp+71]
        mov [rax], bl
        ; branch t.31, false, while_40, if_51_then
        lea rax, [rsp+71]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_48_then:
        ...
        lea rax, [rsp+68]
        mov [rax], bl
        ; branch t.28, false, while_40, if_49_then
        lea rax, [rsp+68]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_49_then:
        ...
        lea rax, [rsp+69]
        mov [rax], bl
        ; branch t.29, false, while_40, if_50_then
        lea rax, [rsp+69]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_52_end:
        ...
        lea rax, [rsp+74]
        mov [rax], bl
        ; branch t.33, false, if_53_end, if_53_then
        lea rax, [rsp+74]
        mov bl, [rax]
        or bl, bl
        jz _if_53_end
        ...
        lea rax, [rsp+76]
        mov [rax], bl
        ; call setCell@i16@i16@u8[curr_r, curr_c, t.35]
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+10]
...
_if_53_end:
        ...
        lea rbx, [rsp+77]
        mov [rbx], al
        ; branch t.36, true, if_54_then, if_54_end
        lea rax, [rsp+77]
        mov bl, [rax]
        or bl, bl
        jnz _if_54_then
