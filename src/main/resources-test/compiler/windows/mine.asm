...
_if_40_end:
        ...
        mov r8w, [r12]
        ; branch chr{r3} equals 27: main_ret, if_42_end
        cmp r8w, 27
        je _main_ret
        ; branch chr{r3} equals -8120: if_43_then, if_43_else
        cmp r8w, -8120
        je _if_43_then
        ; branch chr{r3} notequals -8112: if_44_else, if_44_then
        cmp r8w, -8112
        jne _if_44_else
        jmp _if_44_then
_if_43_then:
...
_if_44_else:
        ...
        ; load curr_r{r4}, [memVarAddr{r7}]
        mov r9w, [r12]
        ; branch chr{r3} notequals -8117: if_45_else, if_45_then
        cmp r8w, -8117
        jne _if_45_else
        jmp _if_45_then
_if_44_then:
        ...
        jmp _while_39
_if_45_else:
        ; branch chr{r3} notequals -8115: if_46_else, if_46_then
        cmp r8w, -8115
        jne _if_46_else
        jmp _if_46_then
_if_45_then:
...
_if_46_else:
        ...
        ; load curr_c{r5}, [memVarAddr{r7}]
        mov r10w, [r12]
        ; branch chr{r3} notequals 32: if_47_else, if_47_then
        cmp r8w, 32
        jne _if_47_else
        jmp _if_47_then
_if_46_then:
        ...
        jmp _while_39
_if_47_else:
        ; branch chr{r3} notequals 13: main.no_critical_edge_28, if_50_then
        cmp r8w, 13
        jne _main.no_critical_edge_28
        jmp _if_50_then
_if_47_then:
        ; branch needsInitialize{r6} notequals 0: main.no_critical_edge_31, if_48_then
        cmp bl, 0
...
_main.no_critical_edge_28:
        ...
        jmp _while_39
_if_50_then:
        ; branch needsInitialize{r6} equals 0: main.no_critical_edge_29, if_51_then
        cmp bl, 0
...
_while_39:
        ; branch needsInitialize{r6} notequals 0: if_40_end, if_40_then
        cmp bl, 0
        jne _if_40_end
        jmp _if_40_then
_if_41_then:
