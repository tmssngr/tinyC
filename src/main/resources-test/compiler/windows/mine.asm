...
@if_46_else:
        ...
        jmp @if_47_then
@if_46_then:
        ; add t.22{r7}, t.22{r7}, 40
        add r12w, 40
        ; sub t.21{r7}, t.21{r7}, 1
        sub r12w, 1
...
@if_47_else:
        ...
        ; const t.28{r5}, -8115
        mov r10w, -8115
        ; equals t.27{r5}, chr{r3}, t.28{r5}
        cmp r8w, r10w
        sete r10b
        ; branch t.27{r5}, false, @if_48_else, @if_48_then
        or r10b, r10b
        jz @if_48_else
        jmp @if_48_then
@if_47_then:
        ; add t.26{r7}, t.26{r7}, 40
        add r12w, 40
        ; sub t.25{r7}, t.25{r7}, 1
        sub r12w, 1
        ; move curr_c{r0}, curr_c{r7}
        mov ax, r12w
        ; mod curr_c{r2}, curr_c{r0}, 40
...
@if_48_else:
        ...
        ; const t.31{r5}, 32
        mov r10w, 32
        ; equals t.30{r5}, chr{r3}, t.31{r5}
        cmp r8w, r10w
        sete r10b
        ; branch t.30{r5}, false, @if_49_else, @if_49_then
        or r10b, r10b
        jz @if_49_else
        jmp @if_49_then
@if_48_then:
        ; add t.29{r7}, t.29{r7}, 1
        add r12w, 1
        ; move curr_c{r0}, curr_c{r7}
        mov ax, r12w
        ; mod curr_c{r2}, curr_c{r0}, 40
