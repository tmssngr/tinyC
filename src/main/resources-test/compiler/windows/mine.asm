...
@initField@i16@i16:
        ...
        ; addrof memVarAddr{r7}, bombs
        lea r12, [rsp+48]
        ; load bombs{r1}, [memVarAddr{r7}]
        mov cx, [r12]
        jmp @for_30
@for_30_body:
        ; addrof memVarAddr{r7}, bombs
        lea r12, [rsp+48]
        ; store [memVarAddr{r7}], bombs{r1}
        mov [r12], cx
        ...
        mov ax, r9w
        ; mod column{r2}, column{r0}, t.10{r3}
        movsx rax, ax
        movsx r8, r8w
        cqo
        idiv r8
        ; move column{r4}, column{r2}
        mov r9w, dx
        ; addrof memVarAddr{r7}, column
        lea r12, [rsp+52]
...
@if_48_else:
        ...
        cmp r8w, r10w
        sete r10b
        ; branch t.43{r5}, false, @if_49_else, @if_49_then
        or r10b, r10b
        jz @if_49_else
        jmp @if_49_then
@if_48_then:
