...
_if_41_end:
        ...
        lea rax, [rsp+49]
        mov [rax], bl
        ; branch t.14, true, if_44_then, if_44_else
        lea rax, [rsp+49]
        mov bl, [rax]
        or bl, bl
        jnz _if_44_then
...
_if_46_else:
        ...
        lea rax, [rsp+64]
        mov [rax], bl
        ; branch t.22, false, if_47_else, if_47_then
        lea rax, [rsp+64]
        mov bl, [rax]
        or bl, bl
        jz _if_47_else
...
_if_47_else:
        ...
        lea rax, [rsp+68]
        mov [rax], bl
        ; branch t.24, false, if_48_else, if_48_then
        lea rax, [rsp+68]
        mov bl, [rax]
        or bl, bl
        jz _if_48_else
...
_if_48_else:
        ...
        lea rax, [rsp+72]
        mov [rax], bl
        ; branch t.28, false, while_40, if_51_then
        lea rax, [rsp+72]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_48_then:
        ...
        lea rax, [rsp+69]
        mov [rax], bl
        ; branch t.25, false, while_40, if_49_then
        lea rax, [rsp+69]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_49_then:
        ...
        lea rax, [rsp+70]
        mov [rax], bl
        ; branch t.26, false, while_40, if_50_then
        lea rax, [rsp+70]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_52_end:
        ...
        lea rax, [rsp+73]
        mov [rax], bl
        ; branch t.29, false, if_53_end, if_53_then
        lea rax, [rsp+73]
        mov bl, [rax]
        or bl, bl
        jz _if_53_end
        ...
        lea rax, [rsp+75]
        mov [rax], bl
        ; call setCell@i16@i16@u8[curr_r, curr_c, t.31]
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+10]
...
_if_53_end:
        ...
        lea rbx, [rsp+76]
        mov [rbx], al
        ; branch t.32, true, if_54_then, if_54_end
        lea rax, [rsp+76]
        mov bl, [rax]
        or bl, bl
        jnz _if_54_then
