...
_if_47_else:
        ...
        lea rax, [rsp+84]
        mov [rax], bl
        ; branch t.36, false, if_48_else, if_48_then
        lea rax, [rsp+84]
        mov bl, [rax]
        or bl, bl
        jz _if_48_else
...
_if_48_else:
        ...
        lea rax, [rsp+92]
        mov [rax], bl
        ; branch t.42, false, while_40, if_51_then
        lea rax, [rsp+92]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_48_then:
        ...
        lea rax, [rsp+88]
        mov [rax], bl
        ; branch t.38, false, while_40, if_49_then
        lea rax, [rsp+88]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_49_then:
        ...
        lea rax, [rsp+89]
        mov [rax], bl
        ; branch t.39, false, while_40, if_50_then
        lea rax, [rsp+89]
        mov bl, [rax]
        or bl, bl
        jz _while_40
...
_if_52_end:
        ...
        lea rax, [rsp+96]
        mov [rax], bl
        ; branch t.44, false, if_53_end, if_53_then
        lea rax, [rsp+96]
        mov bl, [rax]
        or bl, bl
        jz _if_53_end
        ...
        lea rax, [rsp+98]
        mov [rax], bl
        ; call setCell@i16@i16@u8[curr_r, curr_c, t.46]
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+10]
...
_if_53_end:
        ...
        lea rbx, [rsp+100]
        mov [rbx], al
        ; branch t.48, true, if_54_then, if_54_end
        lea rax, [rsp+100]
        mov bl, [rax]
        or bl, bl
        jnz _if_54_then
