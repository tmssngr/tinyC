...
_if_44_then:
        ...
        mov r8w, r9w
        ; add t.10{r3}, t.10{r3}, 20
        add r8w, 20
        ; sub t.9{r3}, t.9{r3}, 1
        sub r8w, 1
        ; move curr_r{r4}, t.9{r3}
        mov r9w, r8w
...
_if_45_then:
        ...
        ; load curr_r{r4}, [memVarAddr{r7}]
        mov r9w, [r12]
        ; move t.11{r3}, curr_r{r4}
        mov r8w, r9w
        ; add t.11{r3}, t.11{r3}, 1
        add r8w, 1
...
_if_46_then:
        ...
        mov r8w, r10w
        ; add t.13{r3}, t.13{r3}, 40
        add r8w, 40
        ; sub t.12{r3}, t.12{r3}, 1
        sub r8w, 1
        ; move curr_c{r5}, t.12{r3}
        mov r10w, r8w
