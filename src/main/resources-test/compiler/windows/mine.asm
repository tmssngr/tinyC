...
@while_22:
        ...
        ; const t.5{r1}, 0
        mov cx, 0
        ; equals t.4{r1}, value{r3}, t.5{r1}
        cmp r8w, cx
        sete cl
        ; branch t.4{r1}, false, @while_22, @while_22_break
        or cl, cl
        jz @while_22
        ; 132:9 return count
...
@for_30_body:
        ...
        ; addrof memVarAddr{r7}, t.11
        lea r12, [rsp+54]
        ; store [memVarAddr{r7}], t.11{r0}
        mov [r12], al
        jmp @or_2nd_32
@no_critical_edge_8:
        ; addrof memVarAddr{r7}, t.11
...
@if_41_end:
        ...
        ; const t.17{r4}, -8112
        mov r9w, -8112
        ; equals t.16{r4}, chr{r3}, t.17{r4}
        cmp r8w, r9w
        sete r9b
        ; branch t.16{r4}, false, @if_45_else, @if_45_then
        or r9b, r9b
        jz @if_45_else
        jmp @if_45_then
@if_44_then:
        ...
        mov r9w, [r12]
        ; move t.15{r3}, curr_r{r4}
        mov r8w, r9w
        ; add t.15{r3}, t.15{r3}, 20
        add r8w, 20
...
@if_45_else:
        ...
        ; const t.20{r5}, -8117
        mov r10w, -8117
        ; equals t.19{r5}, chr{r3}, t.20{r5}
        cmp r8w, r10w
        sete r10b
        ; branch t.19{r5}, false, @if_46_else, @if_46_then
        or r10b, r10b
        jz @if_46_else
        jmp @if_46_then
@if_45_then:
        ...
        ; load curr_r{r4}, [memVarAddr{r7}]
        mov r9w, [r12]
        ; move t.18{r3}, curr_r{r4}
        mov r8w, r9w
        ; add t.18{r3}, t.18{r3}, 1
        add r8w, 1
        ; move curr_r{r4}, t.18{r3}
        mov r9w, r8w
        ; move curr_r{r0}, curr_r{r4}
        mov ax, r9w
        ; mod curr_r{r2}, curr_r{r0}, 20
...
@if_46_else:
        ...
        ; const t.24{r5}, -8117
        mov r10w, -8117
        ; equals t.23{r5}, chr{r3}, t.24{r5}
        cmp r8w, r10w
        sete r10b
        ; branch t.23{r5}, false, @if_47_else, @if_47_then
        or r10b, r10b
        jz @if_47_else
        jmp @if_47_then
@if_46_then:
        ...
        mov r10w, [r12]
        ; move t.22{r3}, curr_c{r5}
        mov r8w, r10w
        ; add t.22{r3}, t.22{r3}, 40
        add r8w, 40
        ; sub t.21{r3}, t.21{r3}, 1
        sub r8w, 1
        ; move curr_c{r5}, t.21{r3}
        mov r10w, r8w
...
@if_47_else:
        ...
        ; const t.28{r1}, -8115
        mov cx, -8115
        ; equals t.27{r1}, chr{r3}, t.28{r1}
        cmp r8w, cx
        sete cl
        ; branch t.27{r1}, false, @if_48_else, @if_48_then
        or cl, cl
        jz @if_48_else
        jmp @if_48_then
@if_47_then:
        ...
        ; load curr_c{r5}, [memVarAddr{r7}]
        mov r10w, [r12]
        ; move t.26{r3}, curr_c{r5}
        mov r8w, r10w
        ; add t.26{r3}, t.26{r3}, 40
        add r8w, 40
        ; sub t.25{r3}, t.25{r3}, 1
        sub r8w, 1
        ; move curr_c{r5}, t.25{r3}
        mov r10w, r8w
        ; move curr_c{r0}, curr_c{r5}
        mov ax, r10w
        ; mod curr_c{r2}, curr_c{r0}, 40
...
@if_48_else:
        ...
        ; const t.31{r1}, 32
        mov cx, 32
        ; equals t.30{r1}, chr{r3}, t.31{r1}
        cmp r8w, cx
        sete cl
        ; branch t.30{r1}, false, @if_49_else, @if_49_then
        or cl, cl
        jz @if_49_else
        jmp @if_49_then
@if_48_then:
        ; move t.29{r3}, curr_c{r5}
        mov r8w, r10w
        ; add t.29{r3}, t.29{r3}, 1
        add r8w, 1
        ; move curr_c{r5}, t.29{r3}
        mov r10w, r8w
        ; move curr_c{r0}, curr_c{r5}
        mov ax, r10w
        ; mod curr_c{r2}, curr_c{r0}, 40
...
@if_49_then:
        ...
        ; notlog t.32{r0}, needsInitialize{r6}
        or bl, bl
        sete al
