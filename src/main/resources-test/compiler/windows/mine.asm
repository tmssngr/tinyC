...
@if_47_else:
        ...
        lea rax, [rsp+54]
        mov [rax], bl
        ; branch t.22, false, @if_48_else, @if_48_then
        lea rax, [rsp+54]
        mov bl, [rax]
        or bl, bl
        jz @if_48_else
...
@if_48_else:
        ...
        lea rax, [rsp+58]
        mov [rax], bl
        ; branch t.24, false, @if_49_else, @if_49_then
        lea rax, [rsp+58]
        mov bl, [rax]
        or bl, bl
        jz @if_49_else
...
@if_49_else:
        ...
        lea rax, [rsp+62]
        mov [rax], bl
        ; branch t.28, false, @while_40, @if_52_then
        lea rax, [rsp+62]
        mov bl, [rax]
        or bl, bl
        jz @while_40
...
@if_49_then:
        ...
        lea rax, [rsp+59]
        mov [rax], bl
        ; branch t.25, false, @while_40, @if_50_then
        lea rax, [rsp+59]
        mov bl, [rax]
        or bl, bl
        jz @while_40
...
@if_50_then:
        ...
        lea rax, [rsp+60]
        mov [rax], bl
        ; branch t.26, false, @while_40, @if_51_then
        lea rax, [rsp+60]
        mov bl, [rax]
        or bl, bl
        jz @while_40
...
@if_53_end:
        ...
        lea rax, [rsp+63]
        mov [rax], bl
        ; branch t.29, false, @if_54_end, @if_54_then
        lea rax, [rsp+63]
        mov bl, [rax]
        or bl, bl
        jz @if_54_end
...
@if_54_end:
        ...
        lea rbx, [rsp+66]
        mov [rbx], al
        ; branch t.32, true, @if_55_then, @if_55_end
        lea rax, [rsp+66]
        mov bl, [rax]
        or bl, bl
        jnz @if_55_then
