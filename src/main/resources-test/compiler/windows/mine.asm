...
@and_next_6:
        ...
        setge al
@and_next_5:
        ; branch t.2{r0}, false, @checkCellBounds@i16@i16_ret
        or al, al
...
@maybeRevealAround@i16@i16:
        ...
        cmp al, 0
        setne al
        ; branch t.7{r0}, true, @maybeRevealAround@i16@i16_ret
        or al, al
...
@if_41_end:
        ...
        cmp r8w, -8120
        sete r9b
        ; branch t.11{r4}, true, @if_44_then
        or r9b, r9b
        jnz @if_44_then
        ; 237:8 if chr == -8112
        ...
        cmp r8w, -8112
        sete r9b
        ; branch t.17{r4}, false, @if_45_else
        or r9b, r9b
        jz @if_45_else
        jmp @if_45_then
@if_44_then:
...
@if_45_else:
        ...
        cmp r8w, -8117
        sete r9b
        ; branch t.21{r4}, false, @if_46_else
        or r9b, r9b
        jz @if_46_else
        jmp @if_46_then
@if_45_then:
...
@if_46_else:
        ...
        cmp r8w, -8117
        sete r9b
        ; branch t.27{r4}, false, @if_47_else
        or r9b, r9b
        jz @if_47_else
        jmp @if_47_then
@if_46_then:
...
@if_47_else:
        ...
        cmp r8w, -8115
        sete r9b
        ; branch t.33{r4}, false, @if_48_else
        or r9b, r9b
        jz @if_48_else
        jmp @if_48_then
@if_47_then:
...
@if_48_else:
        ...
        cmp r8w, 32
        sete r9b
        ; branch t.37{r4}, false, @if_49_else
        or r9b, r9b
        jz @if_49_else
        jmp @if_49_then
@if_48_then:
        ; const t.35{r4}, 1
        mov r9w, 1
        ; add t.34{r7}, t.34{r7}, t.35{r4}
        add r12w, r9w
        ; const t.36{r4}, 40
        mov r9w, 40
        ; move curr_c{r0}, curr_c{r7}
        mov ax, r12w
        ; mod curr_c{r2}, curr_c{r0}, t.36{r4}
        movsx rax, ax
        movsx r9, r9w
        cqo
        idiv r9
...
@if_49_else:
        ; 262:8 if chr == 13
        ; equals t.42{r0}, chr{r3}, 13
        cmp r8w, 13
        sete al
        ; branch t.42{r0}, false, @no_critical_edge_41
        or al, al
...
@if_49_then:
        ...
        or bl, bl
        sete al
        ; branch t.38{r0}, false, @no_critical_edge_44
        or al, al
...
@if_53_end:
        ...
        or al, al
        sete al
        ; branch t.43{r0}, false, @if_54_end
        or al, al
        jz @if_54_end
        ; const t.46{r0}, 2
        mov al, 2
...
@if_54_end:
        ...
        call @isBomb@u8
        ; branch t.47{r0}, true, @if_55_then
        or al, al
        jnz @if_55_then
        ; move curr_r{r1}, curr_r
        lea r11, [rsp+48]
