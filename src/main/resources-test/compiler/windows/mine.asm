...
@for_30_body:
        ...
        ; store [memVarAddr{r7}], row{r1}
        mov [r12], cx
        ; sub t.12{r0}, t.12{r0}, curr_r{r6}
        sub ax, bx
        ; move t.12{r1}, t.12{r0}
        mov cx, ax
        ...
        ; addrof memVarAddr{r7}, t.10
        lea r12, [rsp+54]
        ; store [memVarAddr{r7}], t.10{r0}
        mov [r12], al
        jmp @or_2nd_32
@no_critical_edge_8:
        ; addrof memVarAddr{r7}, t.10
...
@if_46_then:
        ...
        mov r10w, [r12]
        ; move t.17{r3}, curr_c{r5}
        mov r8w, r10w
        ; add t.17{r3}, t.17{r3}, 40
        add r8w, 40
        ; sub t.16{r3}, t.16{r3}, 1
        sub r8w, 1
...
@if_47_else:
        ...
        mov r10w, [r12]
        ; 250:8 if chr == -8115
        ; equals t.21{r1}, chr{r3}, -8115
        cmp r8w, -8115
        sete cl
        ; branch t.21{r1}, false, @if_48_else, @if_48_then
        or cl, cl
        jz @if_48_else
        jmp @if_48_then
@if_47_then:
        ...
        ; load curr_c{r5}, [memVarAddr{r7}]
        mov r10w, [r12]
        ; move t.20{r3}, curr_c{r5}
        mov r8w, r10w
        ; add t.20{r3}, t.20{r3}, 40
        add r8w, 40
        ; sub t.19{r3}, t.19{r3}, 1
        sub r8w, 1
        ; move curr_c{r5}, t.19{r3}
        mov r10w, r8w
        ; move curr_c{r0}, curr_c{r5}
        mov ax, r10w
        ; mod curr_c{r2}, curr_c{r0}, 40
...
@if_48_else:
        ; 254:8 if chr == 32
        ; equals t.23{r1}, chr{r3}, 32
        cmp r8w, 32
        sete cl
        ; branch t.23{r1}, false, @if_49_else, @if_49_then
        or cl, cl
        jz @if_49_else
        jmp @if_49_then
@if_48_then:
        ...
        mov r8w, r10w
        ; add t.22{r3}, t.22{r3}, 1
        add r8w, 1
        ; move curr_c{r5}, t.22{r3}
        mov r10w, r8w
        ; move curr_c{r0}, curr_c{r5}
        mov ax, r10w
        ; mod curr_c{r2}, curr_c{r0}, 40
