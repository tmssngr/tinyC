...
_printStringLength@@u8@u8:
        ...
        ;   rsp+8: var tmp.__random__
_initRandom@i32:
        ; reserve space for local variables
        sub rsp, 16
        ; move tmp.__random__, salt
        lea rax, [rsp+24]
        mov ebx, [rax]
        lea rax, [rsp+8]
        mov [rax], ebx
        ...
        lea rbx, [rsp+0]
        mov [rbx], rax
        ; store [a.__random__], tmp.__random__
        lea rax, [rsp+0]
        mov rbx, [rax]
        lea rax, [rsp+8]
        mov ecx, [rax]
...
_random:
        ...
        lea rbx, [rsp+48]
        mov [rbx], rax
        ; load tmp.__random__, [a.__random__]
        lea rax, [rsp+48]
        mov rbx, [rax]
        mov eax, [rbx]
        lea rbx, [rsp+56]
        mov [rbx], eax
        ; move r, tmp.__random__
        lea rax, [rsp+56]
        mov ebx, [rax]
        lea rax, [rsp+0]
        mov [rax], ebx
        ...
        lea rax, [rsp+44]
        mov [rax], ebx
        ; move tmp.__random__, t.10
        lea rax, [rsp+40]
        mov ebx, [rax]
        lea rax, [rsp+56]
        mov [rax], ebx
        ; add tmp.__random__, tmp.__random__, t.11
        lea rax, [rsp+56]
        mov ebx, [rax]
        lea rax, [rsp+44]
        mov ecx, [rax]
...
_maybeRevealAround@i16@i16_ret:
        ...
        ;   rsp+55: var t.18
        ;   rsp+56: var t.19
        ;   rsp+64: var a.__random__
        ;   rsp+72: var tmp.__random__
_main:
        ; reserve space for local variables
        sub rsp, 80
        ; begin initialize global variables
        ; const tmp.__random__, 0
        mov eax, 0
        lea rbx, [rsp+72]
        mov [rbx], eax
