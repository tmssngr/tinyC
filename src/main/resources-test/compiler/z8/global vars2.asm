...
start:
        ...
        ; u8 next
next:
        ; addrof a.global{r2}, global
        ld   r2, #hi(var_0)
        ld   r3, #lo(var_0)
        ; load t.global{r1}, [a.global{r2}]
        lde  r1, @rr2
        ; move copy{r0}, t.global{r1}
        ld   r0, r1
        ; addrof a.global1{r2}, global
        ld   r2, #hi(var_0)
        ld   r3, #lo(var_0)
        ; load t.global1{r1}, [a.global1{r2}]
        lde  r1, @rr2
...
main:
        ...
        ; const t.global{r8}, 0
        ld   r8, #%00
        ; addrof a.global{r10}, global
        ld   r10, #hi(var_0)
        ld   r11, #lo(var_0)
        ; store [a.global{r10}], t.global{r8}
        lde  @rr10, r8
