...
main:
        ...
        ld   r0, #%00
        ld   r1, #%0a
        ; addrof memVarAddr{r14}, a
        ld   r14, SPH
        ld   r15, SPL
        add  r15, #%08
        adc  r14, #%00
        ; store [memVarAddr{r14}], tmp.a{r0}
        lde  @rr14, r0
        incw r14
        lde  @rr14, r1
        ; call printIntLf@i16[tmp.a{r0}]
        ...
        add  r15, #%0a
        adc  r14, #%00
        ; store [memVarAddr{r14}], tmp.c{r8}
        lde  @rr14, r8
        incw r14
        lde  @rr14, r9
        ; move tmp.c{r0}, tmp.c{r8}
        ld   r0, r8
        ld   r1, r9
        ; call printIntLf@i16[tmp.c{r0}]
        call printIntLf_Pi16
        ; addrof d{r8}, c
        ld   r8, SPH
        ld   r9, SPL
