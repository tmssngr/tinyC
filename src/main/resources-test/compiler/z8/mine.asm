...
.15:
        ...
        call isFlag_Pu8
        ; branch t.7{r0} equals 0: if_8_end, if_11_then
        cp   r0, #%00
        jr   eq, if__8__end
.16:
        jr   if__11__then
...
if____9____else:
        ...
        ; 81:4 if count > 0
        ; branch count{r0} lteq 0: if_10_else, if_10_then
        cp   r0, #%00
        jr   ule, if__10__else
.18:
        jr   if__10__then
...
getX__Pi16:
        ...
        ; arg column (i16): r2
        ; arg show (bool): r4
printCursor__Pi16__Pi16__Pbool:
        ; save clobbered non-volatile registers
        push r8
        push r9
        push r10
...
if____15____then:
        ...
        call printChar_Pu8
printCursor__Pi16__Pi16__Pbool____ret:
        ; restore clobbered non-volatile registers
        pop  r12
        pop  r11
        pop  r10
...
maybeRevealAround__Pi16__Pi16:
        ...
        call getBombCountAround_Pi16_Pi16
        ; branch t.9{r0} notequals 0: maybeRevealAround@i16@i16_ret, if_30_end
        cp   r0, #%00
...
while____31____body:
        ...
        call getBombCountAround_Pi16_Pi16
        ; branch t.10{r0} notequals 0: if_32_then, while_31
        cp   r0, #%00
        jr   ne, if__32__then
.38:
while____31:
...
or____35:
        ...
        call getBombCountAround_Pi16_Pi16
        ; branch t.11{r0} notequals 0: maybeRevealAround@i16@i16.no_critical_edge_31, while_33
        cp   r0, #%00
        jr   ne, maybeRevealAround_Pi16_Pi16_2eno__critical__edge__31
.40:
while____33:
        ; addrof memVarAddr{r14}, right
        ld   r14, SPH
        ...
        ; branch right{r4} gteq 17: if_34_then, or_35
        cp   r4, #%00
        jr   ge, .41
        jr   ne, if__34__then
        cp   r5, #%11
...
maybeRevealAround__Pi16__Pi16__2eno____critical____edge____31:
        ; addrof memVarAddr{r14}, right
        ld   r14, SPH
        ld   r15, SPL
        add  r15, #%08
...
for____37____body:
        ...
        jr   ne, if__38__end
.42:
        ; branch dc{r4} notequals 0: if_38_end, maybeRevealAround@i16@i16.no_critical_edge_28
        cp   r5, #%00
        jr   ne, if__38__end
        cp   r4, #%00
        jr   ne, if__38__end
...
if____43____end:
        ...
        call printCursor_Pi16_Pi16_Pbool
        ; 288:3 if chr == 27
        ; branch chr{r13} equals 27: main_ret, if_45_end
        cp   r14, #%1b
        jr   ne, .49
        cp   r13, #%00
        jr   eq, main__ret
.49:
        ; branch chr{r13} equals 3: if_46_then, if_46_else
        cp   r14, #%03
        jr   ne, .50
        cp   r13, #%00
        jr   eq, if__46__then
.50:
        ; branch chr{r13} notequals 4: if_47_else, if_47_then
        cp   r14, #%04
        jr   ne, if__47__else
        cp   r13, #%00
        jr   ne, if__47__else
...
if____47____else:
        ; branch chr{r13} notequals 1: if_48_else, if_48_then
        cp   r14, #%01
        jr   ne, if__48__else
        cp   r13, #%00
        jr   ne, if__48__else
...
if____48____else:
        ; branch chr{r13} notequals 2: if_49_else, if_49_then
        cp   r14, #%02
        jr   ne, if__49__else
        cp   r13, #%00
        jr   ne, if__49__else
...
if____49____else:
        ; branch chr{r13} notequals 32: if_50_else, if_50_then
        cp   r14, #%20
        jr   ne, if__50__else
        cp   r13, #%00
        jr   ne, if__50__else
...
if____50____else:
        ; branch chr{r13} notequals 13: while_42, if_53_then
        cp   r14, #%0d
        jr   ne, while__42
        cp   r13, #%00
        jr   ne, while__42
...
if____51____then:
        ...
        call isOpen_Pu8
        ; branch t.17{r0} notequals 0: while_42, if_52_then
        cp   r0, #%00
        jr   ne, while__42
.58:
        jr   if__52__then
...
if____54____end:
        ...
        call isOpen_Pu8
        ; branch t.18{r0} notequals 0: if_55_end, if_55_then
        cp   r0, #%00
        jr   ne, if__55__end
.59:
...
if____55____end:
        ...
        call isBomb_Pu8
        ; branch t.20{r0} notequals 0: if_56_then, if_56_end
        cp   r0, #%00
        jr   ne, if__56__then
.60:
        ; move curr_r{r0}, curr_r{r11}
