...
main:
        ...
        ld   r8, #hi(string_0)
        ld   r9, #lo(string_0)
        ; addrof a.text{r10}, text
        ld   r10, #hi(var_0)
        ld   r11, #lo(var_0)
        ; store [a.text{r10}], t.text{r8}
        lde  @rr10, r8
        incw r10
        lde  @rr10, r9
        ...
        ld   r8, #%00
        ld   r9, #%01
        ; addrof a.text2{r10}, text
        ld   r10, #hi(var_0)
        ld   r11, #lo(var_0)
        ; load t.text2{r12}, [a.text2{r10}]
        lde  r12, @rr10
        incw r10
        lde  r13, @rr10
        ...
        ld   r0, r12
        ld   r1, r13
        ; add second{r0}, second{r0}, t.2{r8}
        add  r1, r9
        adc  r0, r8
