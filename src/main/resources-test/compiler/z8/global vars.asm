...
main:
        ...
        ld   r8, #%00
        ld   r9, #%20
        ; addrof a.space{r10}, space
        ld   r10, #hi(var_0)
        ld   r11, #lo(var_0)
        ; store [a.space{r10}], t.space{r8}
        lde  @rr10, r8
        incw r10
        lde  @rr10, r9
        decw r10
        ...
        ld   r8, #%00
        ld   r9, #%3f
        ; addrof a.next{r10}, next
        ld   r10, #hi(var_1)
        ld   r11, #lo(var_1)
        ; store [a.next{r10}], t.next{r8}
        lde  @rr10, r8
        incw r10
        lde  @rr10, r9
        decw r10
        ...
        ld   r8, #hi(var_0)
        ld   r9, #lo(var_0)
        ; addrof a.ptrToSpace{r10}, ptrToSpace
        ld   r10, #hi(var_2)
        ld   r11, #lo(var_2)
        ; store [a.ptrToSpace{r10}], t.ptrToSpace{r8}
        lde  @rr10, r8
        incw r10
        lde  @rr10, r9
        decw r10
        ...
        ld   r8, #hi(var_2)
        ld   r9, #lo(var_2)
        ; load t.ptrToSpace1{r10}, [a.ptrToSpace1{r8}]
        lde  r10, @rr8
        incw r8
        lde  r11, @rr8
        decw r8
        ...
        add  r9, #%02
        adc  r8, #%00
        ; addrof a.ptrToSpace2{r10}, ptrToSpace
        ld   r10, #hi(var_2)
        ld   r11, #lo(var_2)
        ; store [a.ptrToSpace2{r10}], t.ptrToSpace2{r8}
        lde  @rr10, r8
        incw r10
        lde  @rr10, r9
        decw r10
        ...
        ld   r8, #hi(var_2)
        ld   r9, #lo(var_2)
        ; load t.ptrToSpace3{r10}, [a.ptrToSpace3{r8}]
        lde  r10, @rr8
        incw r8
        lde  r11, @rr8
        decw r8
