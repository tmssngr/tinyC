...
_main:
        ...
        ; const t.text{r8}, [string-0]
        lea rbx, [string_0]
        ; addrof a.text{r0}, text
        lea rax, [var_0]
        ; store [a.text{r0}], t.text{r8}
        mov [rax], rbx
        ; end initialize global variables
        ; addrof a.text1{r8}, text
        lea rbx, [var_0]
        ; load t.text1{r1}, [a.text1{r8}]
        mov rdi, [rbx]
        ...
        ; const t.2{r8}, 1
        mov rbx, 1
        ; addrof a.text2{r0}, text
        lea rax, [var_0]
        ; load t.text2{r0}, [a.text2{r0}]
        mov rax, [rax]
        ; move second{r1}, t.text2{r0}
        mov rdi, rax
        ; add second{r1}, second{r1}, t.2{r8}
        add rdi, rbx
        ; call printString@@u8[second{r1}]
        call _printString@@u8
        ; addrof a.text3{r8}, text
        lea rbx, [var_0]
        ; load t.text3{r8}, [a.text3{r8}]
        mov rbx, [rbx]
        ; load chr{r1}, [t.text3{r8}]
        mov dil, [rbx]
...
_printLength:
        ...
        ; const length{r1}, 0
        mov di, 0
        ; addrof a.text{r8}, text
        lea rbx, [var_0]
        ; load t.text{r8}, [a.text{r8}]
        mov rbx, [rbx]
        ; 16:2 for *ptr != 0
        jmp _for_5
_for_5_body:
