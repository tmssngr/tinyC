...
_getSpacer@i16@i16@i16@i16:
        ...
        ; move t.4{r1}, column{r2}
        mov di, si
        ; sub t.4{r1}, t.4{r1}, 1
        sub di, 1
        ; branch columnCursor{r4} notequals t.4{r1}: if_11_end, if_13_then
        cmp cx, di
        jne _if_11_end
        jmp _if_13_then
_if_12_then:
...
_if_41_then:
        ...
        call _printLeft
        ; branch t.7{r0} notequals 0: if_42_then, if_41_end
        cmp al, 0
        jne _if_42_then
_if_41_end:
        ...
        mov r8w, ax
        ; 231:3 if chr == 27
        ; branch chr{r5} equals 27: main_ret, if_43_end
        cmp r8w, 27
        je _main_ret
        ; branch chr{r5} equals -8120: if_44_then, if_44_else
        cmp r8w, -8120
        je _if_44_then
        ; branch chr{r5} notequals -8112: if_45_else, if_45_then
        cmp r8w, -8112
        jne _if_45_else
        jmp _if_45_then
_if_44_then:
        ...
        mov r8w, di
        ; add t.10{r5}, t.10{r5}, 20
        add r8w, 20
        ; sub t.9{r5}, t.9{r5}, 1
        sub r8w, 1
        ; move curr_r{r1}, t.9{r5}
        mov di, r8w
...
_if_45_else:
        ...
        ; load curr_r{r1}, [memVarAddr{r9}]
        mov di, [r12]
        ; branch chr{r5} notequals -8117: if_46_else, if_46_then
        cmp r8w, -8117
        jne _if_46_else
        jmp _if_46_then
_if_45_then:
        ...
        ; load curr_r{r1}, [memVarAddr{r9}]
        mov di, [r12]
        ; move t.11{r5}, curr_r{r1}
        mov r8w, di
        ; add t.11{r5}, t.11{r5}, 1
        add r8w, 1
        ...
        jmp _while_40
_if_46_else:
        ; branch chr{r5} notequals -8115: if_47_else, if_47_then
        cmp r8w, -8115
        jne _if_47_else
        jmp _if_47_then
_if_46_then:
        ...
        mov r8w, si
        ; add t.13{r5}, t.13{r5}, 40
        add r8w, 40
        ; sub t.12{r5}, t.12{r5}, 1
        sub r8w, 1
        ; move curr_c{r2}, t.12{r5}
        mov si, r8w
...
_if_47_else:
        ...
        ; load curr_c{r2}, [memVarAddr{r9}]
        mov si, [r12]
        ; branch chr{r5} notequals 32: if_48_else, if_48_then
        cmp r8w, 32
        jne _if_48_else
        jmp _if_48_then
_if_47_then:
        ...
        jmp _while_40
_if_48_else:
        ; branch chr{r5} notequals 13: main.no_critical_edge_28, if_51_then
        cmp r8w, 13
        jne _main.no_critical_edge_28
        jmp _if_51_then
_if_48_then:
        ; branch needsInitialize{r8} notequals 0: main.no_critical_edge_31, if_49_then
        cmp bl, 0
...
_main.no_critical_edge_28:
        ...
        jmp _while_40
_if_51_then:
        ; branch needsInitialize{r8} equals 0: main.no_critical_edge_29, if_52_then
        cmp bl, 0
...
_if_49_then:
        ...
        call _isOpen@u8
        ; branch t.15{r0} notequals 0: while_40, if_50_then
        cmp al, 0
        jne _while_40
        jmp _if_50_then
