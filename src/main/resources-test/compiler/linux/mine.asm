...
@for_30_body:
        ...
        ; addrof memVarAddr{r9}, t.10
        lea r12, [rsp+42]
        ; store [memVarAddr{r9}], t.10{r0}
        mov [r12], al
        jmp @or_2nd_32
@no_critical_edge_8:
        ; addrof memVarAddr{r9}, t.10
