...
@for_5_body:
        ...
        ; move t.13{r9}, i{r8}
        mov r12b, bl
        ; and t.13{r9}, t.13{r9}, 15
        and r12b, 15
        ; const t.14{r0}, 0
        mov al, 0
        ; equals t.12{r9}, t.13{r9}, t.14{r0}
        cmp r12b, al
        sete r12b
        ; branch t.12{r9}, false, @if_6_end, @if_6_then
        or r12b, r12b
        jz @if_6_end
        ; move i{r1}, i{r8}
        mov dil, bl
...
@if_6_end:
        ...
        ; move t.16{r9}, i{r8}
        mov r12b, bl
        ; and t.16{r9}, t.16{r9}, 7
        and r12b, 7
        ; const t.17{r0}, 0
        mov al, 0
        ; equals t.15{r9}, t.16{r9}, t.17{r0}
        cmp r12b, al
        sete r12b
        ; branch t.15{r9}, false, @if_7_end, @if_7_then
        or r12b, r12b
        jz @if_7_end
        ; const t.18{r1}, 32
        mov dil, 32
...
@if_7_end:
        ...
        ; move t.20{r9}, i{r8}
        mov r12b, bl
        ; and t.20{r9}, t.20{r9}, 15
        and r12b, 15
        ; const t.21{r0}, 15
        mov al, 15
        ; equals t.19{r9}, t.20{r9}, t.21{r0}
        cmp r12b, al
        sete r12b
        ; branch t.19{r9}, false, @for_5_continue, @if_8_then
        or r12b, r12b
        jz @for_5_continue
        ; const t.22{r1}, 10
        mov dil, 10
