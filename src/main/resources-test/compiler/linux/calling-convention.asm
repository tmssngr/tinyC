...
_printStringLength@@u8@u8:
        ...
        ;   rsp+64: arg g
        ;   rsp+72: arg h
_printAndSum@i16@i16@i16@i16@i16@i16@i16@i16:
        sub rsp, 24
        ; save clobbered non-volatile registers
        push r9
        push r10
        ...
        ; load e{r5}, [memVarAddr{r9}]
        mov r8w, [r12]
        ; add t.11{r1}, t.11{r1}, e{r5}
        add di, r8w
        ; addrof memVarAddr{r9}, f
        lea r12, [rsp+42]
        ; load f{r6}, [memVarAddr{r9}]
        mov r9w, [r12]
        ; add t.10{r1}, t.10{r1}, f{r6}
        add di, r9w
        ; addrof memVarAddr{r9}, g
        lea r12, [rsp+64]
...
_main:
        ...
        lea r12, [rsp+0]
        ; store [memVarAddr{r9}], argLit.0.6{r0}
        mov [r12], ax
        ; const argLit.0.7{r0}, 8
        mov ax, 8
        ; addrof memVarAddr{r9}, arg.0.7
        lea r12, [rsp+8]
        ; store [memVarAddr{r9}], argLit.0.7{r0}
        mov [r12], ax
        ; const arg.0.0{r1}, 1
        mov di, 1
        ; const arg.0.1{r2}, 2
        ...
        ; const arg.0.5{r6}, 6
        mov r9w, 6
        ; call sum{r0} = printAndSum@i16@i16@i16@i16@i16@i16@i16@i16[arg.0.0{r1}, arg.0.1{r2}, arg.0.2{r3}, arg.0.3{r4}, arg.0.4{r5}, arg.0.5{r6}, arg.0.6, arg.0.7] -> i16
        call _printAndSum@i16@i16@i16@i16@i16@i16@i16@i16
        ; move sum{r1}, sum{r0}
        mov di, ax
