...
@main:
        ...
        ; const t.14{r8}, 1
        mov rbx, 1
        ; addrof t.13{r9}, [chars]
        lea r12, [var_0]
        ; add t.13{r9}, t.13{r9}, t.14{r8}
        add r12, rbx
        ; load t.12{r8}, [t.13{r9}]
        mov bl, [r12]
        ; const t.15{r9}, 2
        mov r12b, 2
        ; add t.11{r8}, t.11{r8}, t.15{r9}
        add bl, r12b
        ; const t.17{r9}, 2
        mov r12, 2
        ...
        add rax, r12
        ; store [t.16{r0}], t.11{r8}
        mov [rax], bl
        ; const t.19{r8}, 2
        mov rbx, 2
        ; addrof t.18{r9}, [chars]
        lea r12, [var_0]
        ; add t.18{r9}, t.18{r9}, t.19{r8}
        add r12, rbx
        ; load result{r1}, [t.18{r9}]
        mov dil, [r12]
