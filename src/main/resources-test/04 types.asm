...
@for_4:
        ...
        lea rbx, [rsp+5]
        mov [rbx], al
        ; notequals t.2(2@function,bool), i(0@function,u8), t.3(3@function,u8)
        lea rax, [rsp+0]
        mov bl, [rax]
        lea rax, [rsp+5]
        mov cl, [rax]
        ...
        lea rbx, [rsp+16]
        mov [rbx], al
        ; add i(0@function,u8), i(0@function,u8), t.5(5@function,u8)
        lea rax, [rsp+0]
        mov bl, [rax]
        lea rax, [rsp+16]
        mov cl, [rax]
        ...
        jmp @for_4
@for_4_break:
        ; const v(1@function,i16), 260
        mov ax, 260
        lea rbx, [rsp+2]
        mov [rbx], ax
        ; cast t.7(7@function,u8), v(1@function,i16)
        lea rax, [rsp+2]
        mov bx, [rax]
        lea rax, [rsp+32]
        mov [rax], bl
        ; cast t.6(6@function,i64), t.7(7@function,u8)
        lea rax, [rsp+32]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+24]
