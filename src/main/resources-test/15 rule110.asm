...
@for_2:
        ...
        lea rax, [rsp+16]
        mov [rax], rbx
        ; addrof t.6(6@function,u8*), [board(0@global,u8*) + t.7(7@function,i64)]
        lea rax, [rsp+16]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
...
@for_4:
        ...
        lea rax, [rsp+16]
        mov [rax], rbx
        ; addrof t.7(7@function,u8*), [board(0@global,u8*) + t.8(8@function,i64)]
        lea rax, [rsp+16]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
...
@for_4_break:
        ...
        lea rbx, [rsp+25]
        mov [rbx], al
        ; const t.13(13@function,u8), 29
        mov al, 29
        lea rbx, [rsp+48]
        mov [rbx], al
        ; cast t.12(12@function,i64), t.13(13@function,u8)
        lea rax, [rsp+48]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+40]
        mov [rax], rbx
        ; addrof t.11(11@function,u8*), [board(0@global,u8*) + t.12(12@function,i64)]
        lea rax, [rsp+40]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+32]
        mov [rcx], rax
        ; store [t.11(11@function,u8*)], t.10(10@function,u8)
        lea rax, [rsp+32]
        mov rbx, [rax]
        lea rax, [rsp+25]
        mov cl, [rax]
...
@for_5:
        ...
        or bl, bl
        jz @for_5_break
        ; const t.19(19@function,i64), 0
        mov rax, 0
        lea rbx, [rsp+64]
        mov [rbx], rax
        ; addrof t.18(18@function,u8*), [board(0@global,u8*) + t.19(19@function,i64)]
        lea rax, [rsp+64]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+56]
        mov [rcx], rax
        ; load t.17(17@function,u8), [t.18(18@function,u8*)]
        lea rax, [rsp+56]
        mov rbx, [rax]
        mov al, [rbx]
        lea rbx, [rsp+52]
        ...
        lea rax, [rsp+51]
        mov [rax], bl
        ; const t.23(23@function,i64), 1
        mov rax, 1
        lea rbx, [rsp+88]
        mov [rbx], rax
        ; addrof t.22(22@function,u8*), [board(0@global,u8*) + t.23(23@function,i64)]
        lea rax, [rsp+88]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+80]
        mov [rcx], rax
        ; load t.21(21@function,u8), [t.22(22@function,u8*)]
        lea rax, [rsp+80]
        mov rbx, [rax]
        mov al, [rbx]
        lea rbx, [rsp+73]
...
@for_6:
        ...
        lea rbx, [rsp+121]
        mov [rbx], al
        ; add t.33(33@function,u8), j(3@function,u8), t.34(34@function,u8)
        lea rax, [rsp+3]
        mov bl, [rax]
        lea rax, [rsp+121]
        mov cl, [rax]
        ...
        lea rax, [rsp+120]
        mov [rax], bl
        ; cast t.32(32@function,i64), t.33(33@function,u8)
        lea rax, [rsp+120]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+112]
        mov [rax], rbx
        ; addrof t.31(31@function,u8*), [board(0@global,u8*) + t.32(32@function,i64)]
        lea rax, [rsp+112]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+104]
        mov [rcx], rax
        ; load t.30(30@function,u8), [t.31(31@function,u8*)]
        lea rax, [rsp+104]
        mov rbx, [rax]
        mov al, [rbx]
        lea rbx, [rsp+102]
        ...
        lea rax, [rsp+122]
        mov [rax], bl
        ; cast t.40(40@function,i64), j(3@function,u8)
        lea rax, [rsp+3]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+136]
        mov [rax], rbx
        ; addrof t.39(39@function,u8*), [board(0@global,u8*) + t.40(40@function,i64)]
        lea rax, [rsp+136]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+128]
        mov [rcx], rax
        ; store [t.39(39@function,u8*)], t.35(35@function,u8)
        lea rax, [rsp+128]
        mov rbx, [rax]
        lea rax, [rsp+122]
        mov cl, [rax]
