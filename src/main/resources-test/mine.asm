...
@for_19:
        ...
        lea rax, [rsp+14]
        mov [rax], bl
        ; branch t.11, false, @for_19_break
        lea rax, [rsp+14]
        mov bl, [rax]
        or bl, bl
        jz @for_19_break
...
@for_34:
        ...
        lea rax, [rsp+11]
        mov [rax], bl
        ; branch t.9, false, @maybeRevealAround_ret
        lea rax, [rsp+11]
        mov bl, [rax]
        or bl, bl
...
@for_35:
        ...
        lea rax, [rsp+12]
        mov [rax], bl
        ; branch t.10, false, @for_35_break
        lea rax, [rsp+12]
        mov bl, [rax]
        or bl, bl
        jz @for_35_break
