...
@for_19_break:
        ...
        lea rbx, [rsp+16]
        mov [rbx], ax
        ; call spacer, getSpacer, [row, t.12, rowCursor, columnCursor]
        lea rax, [rsp+0]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+24]
...
@or_next_32:
        ...
        lea rbx, [rsp+42]
        mov [rbx], al
        ; call _, setCell [row, column, t.17]
        lea rax, [rsp+2]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+12]
...
@if_53_end:
        ...
        lea rax, [rsp+92]
        mov [rax], bl
        ; call _, setCell [curr_r, curr_c, t.47]
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+10]
