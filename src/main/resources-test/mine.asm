...
@if_53_end:
        ...
        lea rax, [rsp+92]
        mov [rax], bl
        ; call setCell[curr_r, curr_c, t.45]
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+10]
