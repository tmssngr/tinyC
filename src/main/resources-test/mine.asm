...
@getCell:
        sub rsp, 8
        ; 19:15 return [...]
        ; call r0 = rowColumnToCell[r1, r2] -> i16
        sub rsp, 20h; shadow space
...
@for_8_body:
        ...
        lea r11, [rsp+22]
        mov [r11], r10w
        ; call r0 = checkCellBounds[r1, r2] -> bool
        sub rsp, 20h; shadow space
...
@if_15_else:
        ...
        lea r11, [rsp+48]
        mov dx, [r11]
        ; call r0 = getBombCountAround[r1, r2] -> u8
        sub rsp, 20h; shadow space
...
@for_19_body:
        ...
        lea r11, [rsp+18]
        mov [r11], ax
        ; call r0 = getSpacer[r1, r2, r3, r4] -> u8
        sub rsp, 20h; shadow space
        call @getSpacer
        add rsp, 20h
        ; move r1, r0
