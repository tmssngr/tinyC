...
@for_8_body:
        ...
        ; call t.12 = checkCellBounds[r, c] -> bool
        lea rax, [rsp+4]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+16]
...
@for_19:
        ...
        lea rbx, [rsp+22]
        mov [rbx], ax
        ; call spacer = getSpacer[row, t.15, rowCursor, columnCursor] -> u8
        lea rax, [rsp+0]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+30]
...
@and_next_37:
        ...
        ; call t.18 = checkCellBounds[r, c] -> bool
        lea rax, [rsp+2]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+14]
...
@if_52_then:
        ...
        jmp @if_53_then
@if_50_then:
        ; cast t.48(i16), curr_r(u8)
        lea rax, [rsp+2]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+78]
        mov [rax], bx
        ; cast t.49(i16), curr_c(u8)
        lea rax, [rsp+1]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+80]
        mov [rax], bx
        ; call cell = getCell[t.48, t.49] -> u8
        lea rax, [rsp+78]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+88]
...
@if_53_then:
        ...
        lea rbx, [rsp+0]
        mov [rbx], al
        ; cast t.57(i16), curr_r(u8)
        lea rax, [rsp+2]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+94]
        mov [rax], bx
        ; cast t.58(i16), curr_c(u8)
        lea rax, [rsp+1]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+96]
        mov [rax], bx
        ; call initField[t.57, t.58]
        lea rax, [rsp+94]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+104]
...
@if_51_then:
        ...
        lea rax, [rsp+6]
        mov [rax], bl
        ; cast t.53(i16), curr_r(u8)
        lea rax, [rsp+2]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+86]
        mov [rax], bx
        ; cast t.54(i16), curr_c(u8)
        lea rax, [rsp+1]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+88]
        mov [rax], bx
        ; call setCell[t.53, t.54, cell]
        lea rax, [rsp+86]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+96]
        ...
        jmp @while_40
@if_53_end:
        ; cast t.59(i16), curr_r(u8)
        lea rax, [rsp+2]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+98]
        mov [rax], bx
        ; cast t.60(i16), curr_c(u8)
        lea rax, [rsp+1]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+100]
        mov [rax], bx
        ; call cell = getCell[t.59, t.60] -> u8
        lea rax, [rsp+98]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+108]
...
@if_54_end:
        ...
        lea rbx, [rsp+110]
        mov [rbx], al
        ; branch t.67, true, @if_55_then
        lea rax, [rsp+110]
        mov bl, [rax]
        or bl, bl
        jnz @if_55_then
        ; cast t.71(i16), curr_r(u8)
        lea rax, [rsp+2]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+128]
        mov [rax], bx
        ; cast t.72(i16), curr_c(u8)
        lea rax, [rsp+1]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+130]
        mov [rax], bx
        ; call maybeRevealAround[t.71, t.72]
        lea rax, [rsp+128]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+138]
...
@if_42_then:
        ...
        jmp @main_ret
@if_55_then:
        ; cast t.68(i16), curr_r(u8)
        lea rax, [rsp+2]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+112]
        mov [rax], bx
        ; cast t.69(i16), curr_c(u8)
        lea rax, [rsp+1]
        mov bl, [rax]
        movzx bx, bl
        lea rax, [rsp+114]
        mov [rax], bx
        ; call printField[t.68, t.69]
        lea rax, [rsp+112]
        mov bx, [rax]
        push rbx
        lea rax, [rsp+122]
