...
@main:
        ...
        ; const t.21{r7}, 2
        mov r12, 2
        ; cast t.22{r7}(u8*), t.21{r7}(i64)
        ; addrof t.20{r0}, [chars]
        lea rax, [var_0]
        ; add t.20{r0}, t.20{r0}, t.22{r7}
        add rax, r12
        ; store [t.20{r0}], t.14{r6}
        mov [rax], bl
        ; const t.24{r6}, 2
        mov rbx, 2
        ; cast t.25{r6}(u8*), t.24{r6}(i64)
        ; addrof t.23{r7}, [chars]
        lea r12, [var_0]
        ; add t.23{r7}, t.23{r7}, t.25{r6}
        add r12, rbx
        ; load result{r1}, [t.23{r7}]
        mov cl, [r12]
