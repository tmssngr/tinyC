...
@main:
        ; reserve space for local variables
        sub rsp, 32
        ; const a(0@function,u8), 1
        mov al, 1
        lea rbx, [rsp+0]
        mov [rbx], al
        ; const b(1@function,u8), 2
        mov al, 2
        lea rbx, [rsp+1]
        mov [rbx], al
        ; 6:2 if a > b
        ; gt t.2(2@function,bool), a(0@function,u8), b(1@function,u8)
        lea rax, [rsp+0]
        mov bl, [rax]
        lea rax, [rsp+1]
        mov cl, [rax]
        ...
        lea rax, [rsp+2]
        mov [rax], bl
        ; branch t.2(2@function,bool), false, @if_4_else
        lea rax, [rsp+2]
        mov bl, [rax]
        or bl, bl
        jz @if_4_else
        ; cast t.3(3@function,i64), a(0@function,u8)
        lea rax, [rsp+0]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+8]
        ...
        jmp @main_ret
@if_4_else:
        ; cast t.4(4@function,i64), b(1@function,u8)
        lea rax, [rsp+1]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+16]
