...
@for_4_break:
        ...
        lea rbx, [rsp+56]
        mov [rbx], al
        ; cast t.12(i64), t.13(u8)
        lea rax, [rsp+56]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+48]
        mov [rax], rbx
        ; cast t.14(u8*), t.12(i64)
        lea rax, [rsp+48]
        mov rbx, [rax]
        lea rax, [rsp+64]
        mov [rax], rbx
...
@for_6:
        ...
        lea rax, [rsp+160]
        mov [rax], bl
        ; cast t.35(i64), t.36(u8)
        lea rax, [rsp+160]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+152]
        mov [rax], rbx
        ; cast t.38(u8*), t.35(i64)
        lea rax, [rsp+152]
        mov rbx, [rax]
        lea rax, [rsp+168]
        mov [rax], rbx
