...
@main:
        ...
        ; const t.8{r7}, 21
        mov r12b, 21
        ; cast foo{r7}(i16), t.8{r7}(u8)
        movzx r12w, r12b
        ; cast t.9{r1}(i64), foo{r7}(i16)
        movzx rcx, r12w
        ; call printIntLf[t.9{r1}]
        call @printIntLf
        ; cast t.10{r1}(i64), bazz{r6}(i16)
        movzx rcx, bx
        ...
        ; move t.12{r3}, a{r6}
        mov r8w, bx
        ; move t.12{r0}, t.12{r3}
        mov ax, r8w
        ; div t.12{r0}, t.12{r0}, b{r7}
        movsx rax, ax
        movsx r12, r12w
        cqo
        idiv r12
        ; move t.12{r3}, t.12{r0}
        mov r8w, ax
        ; cast t.11{r1}(i64), t.12{r3}(i16)
        movzx rcx, r8w
        ; call printIntLf[t.11{r1}]
        call @printIntLf
        ; const t.15{r7}, 255
        mov r12w, 255
        ; and t.14{r6}, t.14{r6}, t.15{r7}
        and bx, r12w
        ; cast t.13{r1}(i64), t.14{r6}(i16)
        movzx rcx, bx
        ...
        ; move b{r1}, b{r7}
        mov cx, r12w
        ; shiftright t.17{r6}, t.17{r6}, b{r1}
        sar bx, cl
        ; cast t.16{r1}(i64), t.17{r6}(i16)
        movzx rcx, bx
        ...
        ; move b{r1}, b{r7}
        mov cx, r12w
        ; shiftright t.19{r6}, t.19{r6}, b{r1}
        sar bx, cl
        ; cast t.18{r1}(i64), t.19{r6}(i16)
        movzx rcx, bx
        ...
        ; move b{r1}, b{r7}
        mov cx, r12w
        ; shiftleft t.21{r6}, t.21{r6}, b{r1}
        sal bx, cl
        ; cast t.20{r1}(i64), t.21{r6}(i16)
        movzx rcx, bx
