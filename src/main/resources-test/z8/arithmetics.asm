...
@main:
        ...
        ; const t.7{r12}, 21
        ld r12, #%15
        ; cast foo{r10}(i16), t.7{r12}(u8)
        not implemented
        ; move foo{r0}, foo{r10}
        ld r0, r10
        ld r1, r11
        ; call printIntLf[foo{r0}]
        call printIntLf
        ; move bazz{r0}, bazz{r8}
        ld r0, r8
        ld r1, r9
        ; call printIntLf[bazz{r0}]
        call printIntLf
        ; const a{r8}, 1000
        ld r8, #%03
        ld r9, #%e8
        ...
        ld r0, r8
        ld r1, r9
        ; shiftright t.11{r0}, t.11{r0}, b{r10}
        not implemented
        ...
        ld r0, r8
        ld r1, r9
        ; shiftright t.12{r0}, t.12{r0}, b{r10}
        not implemented
        ...
        ld r0, r8
        ld r1, r9
        ; shiftleft t.13{r0}, t.13{r0}, b{r10}
        not implemented
