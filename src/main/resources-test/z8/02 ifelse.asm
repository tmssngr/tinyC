...
@main:
        ...
        ; const r.0(0@register,u8), 1
        ld r0, 1
        ; const r.1(1@register,u8), 2
        ld r4, 2
        ; 6:2 if a > b
        ; copy a(0@function,u8), r.0(0@register,u8)
        ; copy b(1@function,u8), r.1(1@register,u8)
        ; gt r.0(0@register,bool), r.0(0@register,u8), r.1(1@register,u8)
        ; branch r.0(0@register,bool), false, @if_5_else
        jz @if_5_else
        ; @if_5_then
@if_5_then:
        ; copy r.0(0@register,u8), a(0@function,u8)
        ; cast r.0(0@register,i16), r.0(0@register,u8)
        ; call _, printIntLf [r.0(0@register,i16)]
        ; jump @if_5_end
        jmp @if_5_end
@if_5_else:
        ; copy r.0(0@register,u8), b(1@function,u8)
        ; cast r.0(0@register,i16), r.0(0@register,u8)
        ; call _, printIntLf [r.0(0@register,i16)]
@if_5_end:
@main_ret:
