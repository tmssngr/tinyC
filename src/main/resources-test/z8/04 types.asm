...
@for_5:
        ...
        ; notequals r0(bool t.2), r1(u8 i), r0(u8 t.3)
        ; branch r0(bool t.2), false, @for_5_break
        jz @for_5_break
        ; @for_5_body
        ; copy r0(u8 i), i(0@function,u8)
        ; cast r1(i16 t.4), r0(u8 i)
        ; call _, printIntLf [r1(i16 t.4)]
        ; const r0(u8 t.5), 1
        ld r0, 1
        ; copy r1(u8 i), i(0@function,u8)
        ; add r0(u8 i), r1(u8 i), r0(u8 t.5)
        ; copy i(0@function,u8), r0(u8 i)
        ; jump @for_5
        jmp @for_5
@for_5_break:
        ...
        ld r1, 4
        ld r0, 1
        ; cast r0(u8 t.7), r0(i16 v)
        ; cast r0(i16 t.6), r0(u8 t.7)
