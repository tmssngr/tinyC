...
@for_5:
        ...
        ld r0, 0
        ; copy r.1(1@register,u8), i(0@function,u8)
        ; cast r.2(2@register,i16), r.1(1@register,u8)
        ; array r.2(2@register,u8*), board(0@global,u8*) + r.2(2@register,i16)
...
@for_7:
        ...
        ; cast r.3(3@register,i16), r.2(2@register,u8)
        ; array r.3(3@register,u8*), board(0@global,u8*) + r.3(3@register,i16)
