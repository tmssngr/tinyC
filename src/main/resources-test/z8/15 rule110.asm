...
@for_3:
        ...
        ; cast r1(i16 t.7), r0(u8 i)
        ; cast r1(u8* t.8), r1(i16 t.7)
...
@for_5:
        ...
        ld r0, 0
        ; copy r1(u8 i), i(0@function,u8)
        ; cast r2(i16 t.8), r1(u8 i)
        ; cast r2(u8* t.9), r2(i16 t.8)
...
@for_5_break:
        ...
        ; const r1(u8 t.14), 29
        ld r4, 29
        ; cast r1(i16 t.13), r1(u8 t.14)
        ; cast r1(u8* t.15), r1(i16 t.13)
...
@for_7:
        ...
        ; branch r0(bool t.28), false, @for_7_break
        jz @for_7_break
        ; @for_7_body
        ; const r0(u8 t.32), 1
        ld r0, 1
        ...
        ; cast r1(i16 t.36), r1(u8 t.37)
        ; cast r1(u8* t.39), r1(i16 t.36)
        ...
        ; cast r3(i16 t.45), r2(u8 j)
        ; cast r3(u8* t.46), r3(i16 t.45)
