...
@while_1:
        ...
        ; branch r.0(0@register,bool), false, @while_1_break
        jz @while_1_break
        ; @while_1_body
@while_1_body:
...
@main:
        ...
        ld r1, 32
        ld r0, 0
        ; const r.1(1@register,i16), 63
        ld r5, 63
        ld r4, 0
        ; copy space(0@global,i16), r.0(0@register,i16)
        ; addrof r.0(0@register,i16*), space(0@global,i16)
        ; end initialize global variables
        ; copy next(1@global,i16), r.1(1@register,i16)
        ; copy ptrToSpace(2@global,i16*), r.0(0@register,i16*)
        ; call _, printIntLf [r.1(1@register,i16)]
        ; copy r.0(0@register,i16*), ptrToSpace(2@global,i16*)
        ; cast r.0(0@register,i16), r.0(0@register,i16*)
