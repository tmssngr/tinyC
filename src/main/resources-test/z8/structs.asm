...
@main:
        ...
        ; inc t.14{r10}
        incw r10
        ; load t.13{r9}, [t.14{r10}]
        lde r9, rr10
        ; cast t.12{r0}(i16), t.13{r9}(u8)
        not implemented
