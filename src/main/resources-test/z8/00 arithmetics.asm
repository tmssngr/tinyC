...
@main:
        ...
        ld r5, 10
        ld r4, 0
        ; copy a(1@function,i16), r.0(0@register,i16)
        ; div r.0(0@register,i16), r.0(0@register,i16), r.1(1@register,i16)
        ; call _, printIntLf [r.0(0@register,i16)]
        ; const r.0(0@register,i16), 255
        ld r1, 255
        ld r0, 0
        ; copy r.1(1@register,i16), a(1@function,i16)
        ...
        ld r5, 2
        ld r4, 0
        ; copy b(2@function,i16), r.1(1@register,i16)
        ; shiftright r.0(0@register,i16), r.0(0@register,i16), r.1(1@register,i16)
        ; call _, printIntLf [r.0(0@register,i16)]
        ; const r.0(0@register,i16), 1
        ld r1, 1
        ld r0, 0
        ; copy r.1(1@register,i16), b(2@function,i16)
