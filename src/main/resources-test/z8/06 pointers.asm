...
@main:
        ...
        ; call _, printIntLf [r0(i16 a)]
        ; addrof r0(i16* b), a(0@function,i16)
        ; load r0(i16 t.4), [r0(i16* b)]
        ; const r1(i16 t.5), 1
        ld r5, 1
        ld r4, 0
        ; sub r0(i16 c), r0(i16 t.4), r1(i16 t.5)
        ; copy c(1@function,i16), r0(i16 c)
        ; call _, printIntLf [r0(i16 c)]
        ; addrof r0(i16* d), c(1@function,i16)
        ; load r1(i16 t.7), [r0(i16* d)]
        ; const r2(i16 t.8), 1
        ld r9, 1
        ld r8, 0
        ; sub r1(i16 t.6), r1(i16 t.7), r2(i16 t.8)
        ; store [r0(i16* d)], r1(i16 t.6)
        ; call _, printIntLf [c(1@function,i16)]
        ; release space for local variables
        add rsp, 4
        ret
