...
@getCell:
        ; 19:15 return [...]
        ; call r0(i16 t.4), rowColumnToCell, [row(0@argument,i16), column(1@argument,i16)]
        ; cast r0(u8* t.5), r0(i16 t.4)
        ; addrof r1(u8* t.3), [field(0@global,u8*)]
        ; add r0(u8* t.3), r1(u8* t.3), r0(u8* t.5)
