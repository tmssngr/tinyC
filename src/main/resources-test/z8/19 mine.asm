...
@for_10:
        ...
        ; lteq r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_10_break
        jz @for_10_break
        ; @for_10_body
@for_10_body:
...
@if_14_end:
        ...
        ; branch r.0(0@register,bool), false, @if_15_end
        jz @if_15_end
        ; @if_15_then
@if_15_then:
        ; 66:11 return 93
...
@if_17_else:
        ...
        ; branch r.0(0@register,bool), false, @if_18_else
        jz @if_18_else
        ; @if_18_then
@if_18_then:
...
@if_16_else:
        ...
        ; branch r.0(0@register,bool), false, @if_19_end
        jz @if_19_end
        ; @if_19_then
@if_19_then:
...
@for_20:
        ...
        ; lt r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_20_break
        jz @for_20_break
        ; @for_20_body
@for_20_body:
...
@for_22:
        ...
        ; gt r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_22_break
        jz @for_22_break
        ; @for_22_body
@for_22_body:
        ; const r.0(0@register,u8), 48
...
@while_24:
        ...
        ; copy count(1@function,u8), r.0(0@register,u8)
        ; branch r.1(1@register,bool), false, @if_25_end
        jz @if_25_end
        ; @if_25_then
@if_25_then:
        ; jump @while_24_break
...
@for_27:
        ...
        ; lt r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_27_break
        jz @for_27_break
        ; @for_27_body
@for_27_body:
        ...
        ld r4, 0
        ; equals r.0(0@register,bool), r.0(0@register,u8), r.1(1@register,u8)
        ; branch r.0(0@register,bool), false, @if_28_end
        jz @if_28_end
        ; @if_28_then
@if_28_then:
        ; const r.0(0@register,i16), 1
...
@for_30:
        ...
        ; lt r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_30_break
        jz @for_30_break
        ; @for_30_body
@for_30_body:
        ; const r.0(0@register,i16), 0
...
@for_31:
        ...
        ; lt r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_31_break
        jz @for_31_break
        ; @for_31_body
@for_31_body:
        ; const r.0(0@register,u8), 0
...
@for_32:
        ...
        ; gt r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_32_break
        jz @for_32_break
        ; @for_32_body
@for_32_body:
...
@for_36:
        ...
        ; lteq r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_36_break
        jz @for_36_break
        ; @for_36_body
@for_36_body:
        ; copy r.0(0@register,i16), row(0@argument,i16)
...
@for_37:
        ...
        ; lteq r.0(0@register,bool), r.1(1@register,i16), r.0(0@register,i16)
        ; branch r.0(0@register,bool), false, @for_37_break
        jz @for_37_break
        ; @for_37_body
@for_37_body:
        ; 187:4 if dr == 0 && dc == 0
...
@if_43_then:
        ...
        ; branch r.0(0@register,bool), false, @if_44_end
        jz @if_44_end
        ; @if_44_then
@if_44_then:
...
@if_43_end:
        ...
        ; equals r.0(0@register,bool), r.0(0@register,i16), r.1(1@register,i16)
        ; branch r.0(0@register,bool), false, @if_45_end
        jz @if_45_end
        ; @if_45_then
@if_45_then:
        ; jump @while_42_break
...
@if_51_then:
        ...
        ; copy r.0(0@register,bool), needsInitialize(0@function,bool)
        ; notlog r.0(0@register,bool), r.0(0@register,bool)
        ; branch r.0(0@register,bool), false, @if_52_end
        jz @if_52_end
        ; @if_52_then
@if_52_then:
