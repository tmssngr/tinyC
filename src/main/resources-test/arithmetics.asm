...
@main:
        ...
        ; move t.14{r2}, a{r6}
        mov dx, bx
        ; and t.14{r2}, t.14{r2}, t.15{r0}
        and dx, ax
        ; cast t.13{r1}(i64), t.14{r2}(i16)
        movzx rcx, dx
        ...
        ; move b{r1}, b{r7}
        mov cx, r12w
        ; shiftright t.17{r0}, t.17{r0}, b{r1}
        sar ax, cl
        ...
        ; move b{r1}, b{r7}
        mov cx, r12w
        ; shiftright t.19{r0}, t.19{r0}, b{r1}
        sar ax, cl
        ; cast t.18{r1}(i64), t.19{r0}(i16)
        movzx rcx, ax
