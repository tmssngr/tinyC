...
@main:
        ; reserve space for local variables
        sub rsp, 48
        ; const i(0@function,u8), 5
        mov al, 5
        lea rbx, [rsp+0]
        mov [rbx], al
        ; 5:2 while i > 0
@while_4:
        ; const t.2(2@function,u8), 0
        mov al, 0
        lea rbx, [rsp+2]
        mov [rbx], al
        ; gt t.1(1@function,bool), i(0@function,u8), t.2(2@function,u8)
        lea rax, [rsp+0]
        mov bl, [rax]
        lea rax, [rsp+2]
        mov cl, [rax]
        ...
        lea rax, [rsp+1]
        mov [rax], bl
        ; branch t.1(1@function,bool), false, @while_4_break
        lea rax, [rsp+1]
        mov bl, [rax]
        or bl, bl
        jz @while_4_break
        ...
        lea rbx, [rsp+16]
        mov [rbx], al
        ; sub i(0@function,u8), i(0@function,u8), t.4(4@function,u8)
        lea rax, [rsp+0]
        mov bl, [rax]
        lea rax, [rsp+16]
        mov cl, [rax]
...
@while_5:
        ...
        mov [rax], bl
        ; 13:3 if i < 5
        ; const t.8(8@function,u8), 5
        mov al, 5
        lea rbx, [rsp+34]
        mov [rbx], al
        ; lt t.7(7@function,bool), i(0@function,u8), t.8(8@function,u8)
        lea rax, [rsp+0]
        mov bl, [rax]
        lea rax, [rsp+34]
        mov cl, [rax]
        ...
        lea rax, [rsp+33]
        mov [rax], bl
        ; branch t.7(7@function,bool), false, @while_5_break
        lea rax, [rsp+33]
        mov bl, [rax]
        or bl, bl
        jz @while_5_break
