...
@main:
        ; reserve space for local variables
        sub rsp, 80
        ; const a(0@function,i16), 10
        mov ax, 10
        lea rbx, [rsp+0]
        mov [rbx], ax
        ; cast t.4(4@function,i64), a(0@function,i16)
        lea rax, [rsp+0]
        mov bx, [rax]
        movzx rbx, bx
        lea rax, [rsp+32]
        ...
        push rbx
          call @printIntLf
        add rsp, 8
        ; addrof b(1@function,i16*), a(0@function,i16)
        lea rax, [rsp+0]
        lea rbx, [rsp+8]
        mov [rbx], rax
        ; load t.5(5@function,i16), [b(1@function,i16*)]
        lea rax, [rsp+8]
        mov rbx, [rax]
        mov ax, [rbx]
        lea rbx, [rsp+40]
        mov [rbx], ax
        ; const t.6(6@function,i16), 1
        mov ax, 1
        lea rbx, [rsp+42]
        mov [rbx], ax
        ; sub c(2@function,i16), t.5(5@function,i16), t.6(6@function,i16)
        lea rax, [rsp+40]
        mov bx, [rax]
        lea rax, [rsp+42]
        mov cx, [rax]
        ...
        lea rax, [rsp+16]
        mov [rax], bx
        ; cast t.7(7@function,i64), c(2@function,i16)
        lea rax, [rsp+16]
        mov bx, [rax]
        movzx rbx, bx
        lea rax, [rsp+48]
        ...
        push rbx
          call @printIntLf
        add rsp, 8
        ; addrof d(3@function,i16*), c(2@function,i16)
        lea rax, [rsp+16]
        lea rbx, [rsp+24]
        mov [rbx], rax
        ; load t.9(9@function,i16), [d(3@function,i16*)]
        lea rax, [rsp+24]
        mov rbx, [rax]
        mov ax, [rbx]
        lea rbx, [rsp+58]
        mov [rbx], ax
        ; const t.10(10@function,i16), 1
        mov ax, 1
        lea rbx, [rsp+60]
        mov [rbx], ax
        ; sub t.8(8@function,i16), t.9(9@function,i16), t.10(10@function,i16)
        lea rax, [rsp+58]
        mov bx, [rax]
        lea rax, [rsp+60]
        mov cx, [rax]
        ...
        lea rax, [rsp+56]
        mov [rax], bx
        ; store [d(3@function,i16*)], t.8(8@function,i16)
        lea rax, [rsp+24]
        mov rbx, [rax]
        lea rax, [rsp+56]
        mov cx, [rax]
        mov [rbx], cx
        ; cast t.11(11@function,i64), c(2@function,i16)
        lea rax, [rsp+16]
        mov bx, [rax]
        movzx rbx, bx
        lea rax, [rsp+64]
