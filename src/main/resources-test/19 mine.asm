...
@for_8:
        ...
        cmp dx, cx
        setle cl
        ; branch r.0(0@register,bool), false, @for_8_break
        or cl, cl
        jz @for_8_break
        ; @for_8_body
@for_8_body:
...
@if_9_then:
        ...
        add rsp, 8
        mov cl, al
        ; branch r.0(0@register,bool), false, @if_10_end
        or cl, cl
        jz @if_10_end
        ; @if_10_then
@if_10_then:
...
@if_14_else:
        ...
        add rsp, 8
        mov cl, al
        ; branch r.0(0@register,bool), false, @if_17_end
        or cl, cl
        jz @if_17_end
        ; @if_17_then
@if_17_then:
...
@for_18:
        ...
        cmp dx, cx
        setl cl
        ; branch r.0(0@register,bool), false, @for_18_break
        or cl, cl
        jz @for_18_break
        ; @for_18_body
@for_18_body:
...
@getDigitCount:
        ...
        lea rbx, [rsp+0]
        mov [rbx], cl
        ; branch r.1(1@register,bool), false, @if_21_end
        or dl, dl
        jz @if_21_end
        ; @if_21_then
@if_21_then:
...
@for_25:
        ...
        cmp dx, cx
        setl cl
        ; branch r.0(0@register,bool), false, @for_25_break
        or cl, cl
        jz @for_25_break
        ; @for_25_body
@for_25_body:
        ...
        cmp cl, dl
        sete cl
        ; branch r.0(0@register,bool), false, @if_26_end
        or cl, cl
        jz @if_26_end
        ; @if_26_then
@if_26_then:
...
@for_28:
        ...
        cmp dx, cx
        setl cl
        ; branch r.0(0@register,bool), false, @for_28_break
        or cl, cl
        jz @for_28_break
        ; @for_28_body
@for_28_body:
...
@for_29:
        ...
        cmp dx, cx
        setl cl
        ; branch r.0(0@register,bool), false, @for_29_break
        or cl, cl
        jz @for_29_break
        ; @for_29_body
@for_29_body:
...
@or_next_32:
        ...
        lea rbx, [rsp+6]
        mov cl, [rbx]
        ; branch r.0(0@register,bool), false, @if_31_end
        or cl, cl
        jz @if_31_end
        ; @if_31_then
@if_31_then:
...
@for_34:
        ...
        cmp dx, cx
        setle cl
        ; branch r.0(0@register,bool), false, @for_34_break
        or cl, cl
        jz @for_34_break
        ; @for_34_body
@for_34_body:
...
@for_35:
        ...
        cmp dx, cx
        setle cl
        ; branch r.0(0@register,bool), false, @for_35_break
        or cl, cl
        jz @for_35_break
        ; @for_35_body
@for_35_body:
...
@if_41_then:
        ...
        add rsp, 8
        mov cl, al
        ; branch r.0(0@register,bool), false, @if_42_end
        or cl, cl
        jz @if_42_end
        ; @if_42_then
@if_42_then:
...
@if_50_then:
        ...
        or cl, cl
        sete cl
        ; branch r.0(0@register,bool), false, @if_51_end
        or cl, cl
        jz @if_51_end
        ; @if_51_then
@if_51_then:
