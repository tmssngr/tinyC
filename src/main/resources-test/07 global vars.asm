...
@main:
        ...
        lea rax, [var_1]
        mov [rax], dx
        ; cast r1(i64 t.0), r1(i16 next)
        movzx rdx, dx
        ; copy ptrToSpace(2@global,i16*), r0(i16* ptrToSpace)
        lea rax, [var_2]
        mov [rax], rcx
        ; call _, printIntLf [r1(i64 t.0)]
        push rdx
          call @printIntLf
        add rsp, 8
        ...
        lea rax, [var_2]
        mov rcx, [rax]
        ; cast r0(i64 t.2), r0(i16* ptrToSpace)
        ; const r1(i64 t.3), 2
        mov rdx, 2
        ; add r0(i64 t.1), r0(i64 t.2), r1(i64 t.3)
        add rcx, rdx
        ; cast r0(i16* ptrToSpace), r0(i64 t.1)
        ; copy ptrToSpace(2@global,i16*), r0(i16* ptrToSpace)
        lea rax, [var_2]
        mov [rax], rcx
        ; load r0(i16 t.5), [r0(i16* ptrToSpace)]
        mov cx, [rcx]
