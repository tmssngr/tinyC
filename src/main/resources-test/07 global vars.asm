...
@main:
        ...
        lea rbx, [var_0]
        mov [rbx], ax
        ; const next(1@global,i16), 63
        mov ax, 63
        lea rbx, [var_1]
        mov [rbx], ax
        ; addrof ptrToSpace(2@global,i16*), space(0@global,i16)
        lea rax, [var_0]
        lea rbx, [var_2]
        mov [rbx], rax
        ; end initialize global variables
        ; cast t.1(1@function,i64), ptrToSpace(2@global,i16*)
        lea rax, [var_2]
        mov rbx, [rax]
        lea rax, [rsp+8]
        mov [rax], rbx
        ; const t.3(3@function,i64), 1
        mov rax, 1
        lea rbx, [rsp+24]
        mov [rbx], rax
        ; const t.4(4@function,i64), 2
        mov rax, 2
        lea rbx, [rsp+32]
        mov [rbx], rax
        ; mul t.2(2@function,i64), t.3(3@function,i64), t.4(4@function,i64)
        lea rax, [rsp+24]
        mov rbx, [rax]
        lea rax, [rsp+32]
        mov rcx, [rax]
        ...
        lea rax, [rsp+16]
        mov [rax], rbx
        ; add t.0(0@function,i16*), t.1(1@function,i64), t.2(2@function,i64)
        lea rax, [rsp+8]
        mov rbx, [rax]
        lea rax, [rsp+16]
        mov rcx, [rax]
        ...
        lea rax, [rsp+0]
        mov [rax], rbx
        ; cast ptrToSpace(2@global,i16*), t.0(0@function,i16*)
        lea rax, [rsp+0]
        mov rbx, [rax]
        lea rax, [var_2]
        mov [rax], rbx
        ; load t.6(6@function,i16), [ptrToSpace(2@global,i16*)]
        lea rax, [var_2]
        mov rbx, [rax]
        mov ax, [rbx]
        lea rbx, [rsp+48]
        mov [rbx], ax
        ; cast t.5(5@function,i64), t.6(6@function,i16)
        lea rax, [rsp+48]
        mov bx, [rax]
        movzx rbx, bx
        lea rax, [rsp+40]
