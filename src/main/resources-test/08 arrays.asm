...
@main:
        ...
        lea rbx, [rsp+16]
        mov [rbx], rax
        ; addrof t.2(2@function,u8*), [chars(0@global,u8*) + t.3(3@function,i64)]
        lea rax, [rsp+16]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        ...
        mov cl, [rax]
        mov [rbx], cl
        ; const t.7(7@function,i64), 0
        mov rax, 0
        lea rbx, [rsp+40]
        mov [rbx], rax
        ; addrof t.6(6@function,u8*), [chars(0@global,u8*) + t.7(7@function,i64)]
        lea rax, [rsp+40]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        ...
        lea rbx, [rsp+48]
        mov [rbx], al
        ; add t.4(4@function,u8), t.5(5@function,u8), t.8(8@function,u8)
        lea rax, [rsp+25]
        mov bl, [rax]
        lea rax, [rsp+48]
        mov cl, [rax]
        ...
        lea rax, [rsp+24]
        mov [rax], bl
        ; const t.10(10@function,i64), 1
        mov rax, 1
        lea rbx, [rsp+64]
        mov [rbx], rax
        ; addrof t.9(9@function,u8*), [chars(0@global,u8*) + t.10(10@function,i64)]
        lea rax, [rsp+64]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+56]
        mov [rcx], rax
        ; store [t.9(9@function,u8*)], t.4(4@function,u8)
        lea rax, [rsp+56]
        mov rbx, [rax]
        lea rax, [rsp+24]
        mov cl, [rax]
        mov [rbx], cl
        ; const t.14(14@function,i64), 1
        mov rax, 1
        lea rbx, [rsp+88]
        mov [rbx], rax
        ; addrof t.13(13@function,u8*), [chars(0@global,u8*) + t.14(14@function,i64)]
        lea rax, [rsp+88]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+80]
        mov [rcx], rax
        ; load t.12(12@function,u8), [t.13(13@function,u8*)]
        lea rax, [rsp+80]
        mov rbx, [rax]
        mov al, [rbx]
        lea rbx, [rsp+73]
        ...
        lea rbx, [rsp+96]
        mov [rbx], al
        ; add t.11(11@function,u8), t.12(12@function,u8), t.15(15@function,u8)
        lea rax, [rsp+73]
        mov bl, [rax]
        lea rax, [rsp+96]
        mov cl, [rax]
        ...
        lea rax, [rsp+72]
        mov [rax], bl
        ; const t.18(18@function,u8), 2
        mov al, 2
        lea rbx, [rsp+120]
        mov [rbx], al
        ; cast t.17(17@function,i64), t.18(18@function,u8)
        lea rax, [rsp+120]
        mov bl, [rax]
        movzx rbx, bl
        lea rax, [rsp+112]
        mov [rax], rbx
        ; addrof t.16(16@function,u8*), [chars(0@global,u8*) + t.17(17@function,i64)]
        lea rax, [rsp+112]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+104]
        mov [rcx], rax
        ; store [t.16(16@function,u8*)], t.11(11@function,u8)
        lea rax, [rsp+104]
        mov rbx, [rax]
        lea rax, [rsp+72]
        mov cl, [rax]
        mov [rbx], cl
        ; const t.20(20@function,i64), 2
        mov rax, 2
        lea rbx, [rsp+136]
        mov [rbx], rax
        ; addrof t.19(19@function,u8*), [chars(0@global,u8*) + t.20(20@function,i64)]
        lea rax, [rsp+136]
        mov rbx, [rax]
        lea rax, [var_0]
        add rax, rbx
        lea rcx, [rsp+128]
        mov [rcx], rax
        ; load result(1@function,u8), [t.19(19@function,u8*)]
        lea rax, [rsp+128]
        mov rbx, [rax]
        mov al, [rbx]
        lea rbx, [rsp+1]
