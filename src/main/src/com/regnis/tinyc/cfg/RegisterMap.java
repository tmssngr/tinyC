...
public final class RegisterMap {
	...
	public static boolean contains(IRVar var, Set<LiveVar> lives) {
	...
	public IRVar getRegisterVar(@NotNull IRVar var) {
		...
		return register != null
				? IRVar.createRegisterVar(register.index, var.type())
				: null;
	}
	...
	public IRVar maybeFreeRegister(@NotNull IRVar var) {
		...
		register.free();
		return IRVar.createRegisterVar(register.index, var.type());
	}
	...
	public void maybeSpillRegisters(Set<LiveVar> liveBefore, Set<LiveVar> lastUsed, Set<LiveVar> uses, Set<LiveVar> defines,
	...
	@NotNull
	private Register spill(LiveVar[] occupiedRegisters, Set<LiveVar> dontSpill, BiConsumer<IRVar, IRVar> consumer) {
	...
	@Nullable
	private Register getRegister(@NotNull LiveVar var) {
	...
	private static class Register {
		...
		public void storeRegisterInVar(@NotNull BiConsumer<IRVar, IRVar> consumer) {
			...
			final IRVar registerVar = IRVar.createRegisterVar(index, var.type());
