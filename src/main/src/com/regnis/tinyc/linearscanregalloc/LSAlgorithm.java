...
final class LSAlgorithm {
	...
	public LSAlgorithm(@NotNull List<LSInterval> varIntervals, @NotNull List<LSInterval> fixedIntervals, @NotNull List<LSIntervalFactory.Indices> blockBoundaries, @NotNull LSTypeRegisterCountProvider typeRegisterCountProvider, int registerCount) {
