 ...
 */
final class LSPreprocessorX86OperationsLayer extends IRConverterAbstractLayer {
	private final X86Registers registers;

	public LSPreprocessorX86OperationsLayer(@NotNull X86Registers registers, @NotNull IRConverterLayer nextLayer) {
		super(nextLayer);
