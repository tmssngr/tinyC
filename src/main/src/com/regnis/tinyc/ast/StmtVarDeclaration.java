 ...
 */
public record StmtVarDeclaration(@NotNull String typeString, @NotNull String varName, int index, @Nullable VariableScope scope, @Nullable Type type, @NotNull Expression expression, @NotNull Location location) implements StmtDeclaration {
