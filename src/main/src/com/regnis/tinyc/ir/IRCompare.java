 ...
 */
public record IRCompare(@NotNull IRVar target, @NotNull Op op, @NotNull IRVar left, @NotNull IRValue right, @NotNull Location location) implements IRInstruction {
	public IRCompare(@NotNull IRVar target, @NotNull Op op, @NotNull IRVar left, @NotNull IRValue right) {
		this(target, op, left, right, Location.DUMMY);
	}

	public IRCompare(@NotNull IRVar target, @NotNull Op op, @NotNull IRVar left, @NotNull IRVar right, @NotNull Location location) {
		this(target, op, left, new IRValue(right), location);
	}

	public IRCompare(@NotNull IRVar target, @NotNull Op op, @NotNull IRVar left, int rightValue, @NotNull Location location) {
